...
class Ahindi extends CI_Controller {
	    ...
	    if(isset($_POST) && !empty($_POST)){
    		...
    		if ($this->form_validation->run() == false) {
                ...
                if($response){
                    ...
                    redirect(base_url().'index.php/ahindi/addheadmenu');
                }else{
	...
	public function updateheadmenu($id){
		...
		if ($this->form_validation->run() == false) {
            ...
            if($response){
                ...
                redirect(base_url().'index.php/ahindi/headmenulist');
            }else{
                $this->session->set_flashdata('msg','<div class="alert alert-danger">Failed to Update Menu.</div>');
                redirect(base_url().'index.php/ahindi/editheadmenu/'.$id);
            }
		}
	}
	...
	public function addleftmenu(){
	    ...
	    if(isset($_POST) && !empty($_POST)){
    		...
    		if ($this->form_validation->run() == false) {
                ...
                if($response){
                    $this->session->set_flashdata('msg','<div class="alert alert-success">Menu Added Successfully.</div>');
                    redirect(base_url().'index.php/ahindi/addleftmenu');
                }else{
                    $this->session->set_flashdata('msg','<div class="alert alert-danger">Failed to Add Menu.</div>');
                    redirect(base_url().'index.php/ahindi/addleftmenu');
                }
	...
	public function updateleftmenu($id){
		...
		if ($this->form_validation->run() == false) {
            ...
            if($response){
                $this->session->set_flashdata('msg','<div class="alert alert-success">Menu Updated Successfully.</div>');
                redirect(base_url().'index.php/ahindi/leftmenulist');
            }else{
                $this->session->set_flashdata('msg','<div class="alert alert-danger">Failed to Update Menu.</div>');
                redirect(base_url().'index.php/ahindi/editleftmenu/'.$id);
            }
		}
	}
	...
	public function addprofilemenu(){
	    ...
	    if(isset($_POST) && !empty($_POST)){
    		...
    		if ($this->form_validation->run() == false) {
                ...
                if($response){
                    $this->session->set_flashdata('msg','<div class="alert alert-success">Menu Added Successfully.</div>');
                    redirect(base_url().'index.php/ahindi/addprofilemenu');
                }else{
                    $this->session->set_flashdata('msg','<div class="alert alert-danger">Failed to Add Menu.</div>');
                    redirect(base_url().'index.php/ahindi/addprofilemenu');
                }
	...
	public function updateprofilemenu($id){
		...
		if ($this->form_validation->run() == false) {
            ...
            if($response){
                $this->session->set_flashdata('msg','<div class="alert alert-success">Menu Updated Successfully.</div>');
                redirect(base_url().'index.php/ahindi/profilemenulist');
            }else{
                $this->session->set_flashdata('msg','<div class="alert alert-danger">Failed to Update Menu.</div>');
                redirect(base_url().'index.php/ahindi/editprofilemenu/'.$id);
            }
		}
	}
    		...
    		if ($this->form_validation->run() == false) {
				...
				if($this->upload->do_upload('slideimage')){
                    ...
                    if($response){
                        ...
                        redirect(base_url().'index.php/ahindi/addhomeslide');
                    }else{
	...
	public function updatehomeslide($id){
		...
		if ($this->form_validation->run() == false) {
            ...
            if($response){
                ...
                redirect(base_url().'index.php/ahindi/homeslides');
            }else{
                $this->session->set_flashdata('msg','<div class="alert alert-danger">Failed to update Slide.</div>');
                redirect(base_url().'index.php/ahindi/addhomeslide/'.$id);
            }
		}
	}
	...
	public function blockprofile($userid){
	    ...
	    if($response){
            ...
            redirect(base_url().'index.php/ahindi/userslist');
	    }else{
    		...
    		if ($this->form_validation->run() == false) {
				...
				if($this->upload->do_upload('blogimage')){
                    ...
                    if($response){
                        ...
                        redirect(base_url().'index.php/ahindi/addblog');
                    }else{
	...
	public function updateblog($id){
		...
		if ($this->form_validation->run() == false) {
            ...
            if($response){
                ...
                redirect(base_url().'index.php/ahindi/blogs');
            }else{
                $this->session->set_flashdata('msg','<div class="alert alert-danger">Failed to update Blog.</div>');
                redirect(base_url().'index.php/ahindi/editblog/'.$id);
            }
		}
	}
	...
	public function reportblockstory($sid){
        ...
        if($response){
            ...
            redirect(base_url().'index.php/ahindi/reports');
        }else{
	...
	public function blockstory($storyid){
	    ...
	    if($response == 1){
            $this->session->set_flashdata('msg','<div class="alert alert-success">Story Blocked Successfully.</div>');
            redirect(base_url().'index.php/ahindi/storiesreports');
        }else{
            $this->session->set_flashdata('msg','<div class="alert alert-danger">Failed to block Story.</div>');
            redirect(base_url().'index.php/ahindi/storiesreports');
        }
	...
	public function blockcommreportstory($comm_story_id){
	    ...
	    if($response == 1){
            ...
            redirect(base_url().'index.php/ahindi/communitiesreports');
        }else{
	...
	public function unblockcommcmtreport($comm_commentid){
	    ...
	    if($response == 1){
            ...
            redirect(base_url().'index.php/ahindi/communitiescmtreports');
        }else{
    		...
    		if ($this->form_validation->run() == false) {
				...
				if($this->upload->do_upload('comm_image')){
                    ...
                    if($response == 1){
                        ...
                        redirect(base_url().'index.php/ahindi/communities');
                    }else{
	...
	public function geners($id = false){
	    ...
	    if(isset($id) && !empty($id) && (isset($_POST['gener']) && !empty($_POST['gener']))){
	        ...
	        if($response){
                ...
                redirect(base_url().'index.php/ahindi/geners');
            }else{
    		...
    		if ($this->form_validation->run() == false) {
				...
				if($this->upload->do_upload('landimage')){
                    ...
                    if($response){
                        ...
                        redirect(base_url().'index.php/ahindi/addlandingpage');
                    }else{
	    ...
	    if(isset($_POST) && !empty($_POST)){
    		...
    		if ($this->form_validation->run() == false) {
    		    ...
    		    if($response){
                    ...
                    redirect(base_url().'index.php/ahindi/typewrites');
                }else{
	    ...
	    if(isset($_POST) && !empty($_POST)){
    		...
    		if ($this->form_validation->run() == false) {
                ...
                if($response){
                    ...
                    redirect(base_url().'index.php/ahindi/addstaticpage');
                }else{
	...
	public function updatestaticpage($id){
		...
		if ($this->form_validation->run() == false) {
            ...
            if($response){
                ...
                redirect(base_url().'index.php/ahindi/staticpages');
            }else{
                $this->session->set_flashdata('msg','<div class="alert alert-danger">Failed to update Static page.</div>');
                redirect(base_url().'index.php/ahindi/editstaticpage/'.$id);
            }
		}
	}

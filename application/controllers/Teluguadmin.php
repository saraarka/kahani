...
class Teluguadmin extends CI_Controller {
	    ...
	    if(isset($_POST) && !empty($_POST)){
    		...
    		if ($this->form_validation->run() == false) {
                ...
                if($response){
                    ...
                    redirect(base_url().'index.php/teluguadmin/addheadmenu');
                }else{
	...
	public function updateheadmenu($id){
		...
		if ($this->form_validation->run() == false) {
            ...
            if($response){
                ...
                redirect(base_url().'index.php/teluguadmin/headmenulist');
            }else{
                $this->session->set_flashdata('msg','<div class="alert alert-danger">Failed to Update Menu.</div>');
                redirect(base_url().'index.php/teluguadmin/editheadmenu/'.$id);
            }
		}
	}
	...
	public function addleftmenu(){
	    ...
	    if(isset($_POST) && !empty($_POST)){
    		...
    		if ($this->form_validation->run() == false) {
                ...
                if($response){
                    $this->session->set_flashdata('msg','<div class="alert alert-success">Menu Added Successfully.</div>');
                    redirect(base_url().'index.php/teluguadmin/addleftmenu');
                }else{
                    $this->session->set_flashdata('msg','<div class="alert alert-danger">Failed to Add Menu.</div>');
                    redirect(base_url().'index.php/teluguadmin/addleftmenu');
                }
	...
	public function updateleftmenu($id){
		...
		if ($this->form_validation->run() == false) {
            ...
            if($response){
                $this->session->set_flashdata('msg','<div class="alert alert-success">Menu Updated Successfully.</div>');
                redirect(base_url().'index.php/teluguadmin/leftmenulist');
            }else{
                $this->session->set_flashdata('msg','<div class="alert alert-danger">Failed to Update Menu.</div>');
                redirect(base_url().'index.php/teluguadmin/editleftmenu/'.$id);
            }
		}
	}
	...
	public function addprofilemenu(){
	    ...
	    if(isset($_POST) && !empty($_POST)){
    		...
    		if ($this->form_validation->run() == false) {
                ...
                if($response){
                    $this->session->set_flashdata('msg','<div class="alert alert-success">Menu Added Successfully.</div>');
                    redirect(base_url().'index.php/teluguadmin/addprofilemenu');
                }else{
                    $this->session->set_flashdata('msg','<div class="alert alert-danger">Failed to Add Menu.</div>');
                    redirect(base_url().'index.php/teluguadmin/addprofilemenu');
                }
	...
	public function updateprofilemenu($id){
		...
		if ($this->form_validation->run() == false) {
            ...
            if($response){
                $this->session->set_flashdata('msg','<div class="alert alert-success">Menu Updated Successfully.</div>');
                redirect(base_url().'index.php/teluguadmin/profilemenulist');
            }else{
                $this->session->set_flashdata('msg','<div class="alert alert-danger">Failed to Update Menu.</div>');
                redirect(base_url().'index.php/teluguadmin/editprofilemenu/'.$id);
            }
		}
	}
    		...
    		if ($this->form_validation->run() == false) {
				...
				if($this->upload->do_upload('slideimage')){
                    ...
                    if($response){
                        ...
                        redirect(base_url().'index.php/teluguadmin/addhomeslide');
                    }else{
	...
	public function updatehomeslide($id){
		...
		if ($this->form_validation->run() == false) {
            ...
            if($response){
                ...
                redirect(base_url().'index.php/teluguadmin/homeslides');
            }else{
                $this->session->set_flashdata('msg','<div class="alert alert-danger">Failed to update Slide.</div>');
                redirect(base_url().'index.php/teluguadmin/addhomeslide/'.$id);
            }
		}
	}
	...
	public function blockprofile($userid){
	    ...
	    if($response){
            ...
            redirect(base_url().'index.php/teluguadmin/userslist');
	    }else{
	...
	public function deletestory($sid){
	    ...
	    if($response){
            ...
            redirect(base_url().'index.php/teluguadmin/storieslist');
	    }else{
    		...
    		if ($this->form_validation->run() == false) {
				...
				if($this->upload->do_upload('blogimage')){
                    ...
                    if($response){
                        ...
                        redirect(base_url().'index.php/teluguadmin/addblog');
                    }else{
	...
	public function updateblog($id){
		...
		if ($this->form_validation->run() == false) {
            ...
            if($response){
                ...
                redirect(base_url().'index.php/teluguadmin/blogs');
            }else{
                $this->session->set_flashdata('msg','<div class="alert alert-danger">Failed to update Blog.</div>');
                redirect(base_url().'index.php/teluguadmin/editblog/'.$id);
            }
		}
	}
	...
	public function reportblockstory($sid){
        ...
        if($response){
            ...
            redirect(base_url().'index.php/teluguadmin/reports');
        }else{
	...
	public function blockstory($storyid){
	    ...
	    if($response == 1){
            $this->session->set_flashdata('msg','<div class="alert alert-success">Story Blocked Successfully.</div>');
            redirect(base_url().'index.php/teluguadmin/storiesreports');
        }else{
            $this->session->set_flashdata('msg','<div class="alert alert-danger">Failed to block Story.</div>');
            redirect(base_url().'index.php/teluguadmin/storiesreports');
        }
	...
	public function blockcommreportstory($comm_story_id){
	    ...
	    if($response == 1){
            ...
            redirect(base_url().'index.php/teluguadmin/communitiesreports');
        }else{
	...
	public function unblockcommcmtreport($comm_commentid){
	    ...
	    if($response == 1){
            ...
            redirect(base_url().'index.php/teluguadmin/communitiescmtreports');
        }else{
    		...
    		if ($this->form_validation->run() == false) {
				...
				if($this->upload->do_upload('comm_image')){
                    ...
                    if($response == 1){
                        ...
                        redirect(base_url().'index.php/teluguadmin/communities');
                    }else{
	...
	public function geners($id = false){
	    ...
	    if(isset($id) && !empty($id) && (isset($_POST['gener']) && !empty($_POST['gener']))){
	        ...
	        if($response){
                ...
                redirect(base_url().'index.php/teluguadmin/geners');
            }else{
    		...
    		if ($this->form_validation->run() == false) {
				...
				if($this->upload->do_upload('landimage')){
                    ...
                    if($response){
                        ...
                        redirect(base_url().'index.php/teluguadmin/addlandingpage');
                    }else{
	...
	public function updatelandingpage($id){
		...
		if ($this->form_validation->run() == false) {
            ...
            if($response){
                ...
                redirect(base_url().'index.php/teluguadmin/landingpage');
            }else{
                $this->session->set_flashdata('msg','<div class="alert alert-danger">Failed to update Landing page content.</div>');
                redirect(base_url().'index.php/teluguadmin/editlandingpage/'.$id);
            }
		}
	}
	    ...
	    if(isset($_POST) && !empty($_POST)){
    		...
    		if ($this->form_validation->run() == false) {
    		    ...
    		    if($response){
                    ...
                    redirect(base_url().'index.php/teluguadmin/typewrites');
                }else{
	    ...
	    if(isset($_POST) && !empty($_POST)){
    		...
    		if ($this->form_validation->run() == false) {
                ...
                if($response){
                    ...
                    redirect(base_url().'index.php/teluguadmin/addstaticpage');
                }else{
	...
	public function updatestaticpage($id){
		...
		if ($this->form_validation->run() == false) {
            ...
            if($response){
                ...
                redirect(base_url().'index.php/teluguadmin/staticpages');
            }else{
                $this->session->set_flashdata('msg','<div class="alert alert-danger">Failed to update Static page.</div>');
                redirect(base_url().'index.php/teluguadmin/editstaticpage/'.$id);
            }
		}
	}

...
class Telugu1 extends CI_Controller {
    ...
    public function blogloadcomments(){
	     if(isset($_POST["limit"], $_POST["start"], $_POST['blog_id']) && !empty($_POST['blog_id'])){
            $data['blogcomments'] = $this->User_model->blogcomment_get($_POST['blog_id'], $_POST["start"], $_POST["limit"]);
            //print_r($data['blogcomments']);exit();
	...
	public function loadblog(){
	    if(isset($_POST['limit']) && !empty($_POST['start'])){
	        $data['blogs'] = $this->User_model->loadblogs($_POST['start'], $_POST['limit']);
	        $this->load->view('otherlangs/loadblogs.php',$data);
	    }
	}
    /* Blog end*/

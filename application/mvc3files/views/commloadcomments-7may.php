            ...
            <div class="box-footer box-comments editdelete<?php echo $commcomment->id;?>">
    			<div class="box-comment">
            		...
            		<div class="comment-text">
						<span class="username" style="padding-top:6px;">&nbsp; <b><a href="<?php echo base_url().$commcomment->profile_name; ?>"><?php echo ucfirst($commcomment->name);?></a></b>
            		...
            		<div style="margin:8px 0 6px 2px" class="comment-text">
            		    <?php if(strlen($commcomment->comment) > 200){ ?>
        			        <div style="word-break:break-word;" class="more pcomment<?php echo $commcomment->id;?>"><?php echo substr($commcomment->comment, 0, 200); ?>
    		...
    		<div class="media editdelete<?php echo $lsubcomment->id;?>">
    		    <span class="media-left">
    		        ...
    		        <span class="media-body" style="background:#ddd; padding:5px; border-radius:2px;">
    		            <span class="username">&nbsp;<a href="<?php echo base_url().$lsubcomment->profile_name; ?>"><?php echo ucfirst($lsubcomment->name);?></a>
        ...
        <?php if(isset($commloadcomments) && ($commloadcomments->num_rows() > 0)){
            ...
            <div class="box-footer box-comments editdelete<?php echo $commcomment->id;?>" style="padding-left:10px;">
            	<div class="box-comment">
    				...
    				<?php } ?>
    				<div class="comment-text">
    					<span class="username" style="padding-top:6px;">&nbsp; <a href="<?php echo base_url().$commcomment->profile_name; ?>"><?php echo ucfirst($commcomment->name);?></a>
    						<span class="dropdown" style="float:right;">
                                <a href="javascript:void(0);" class="dropdown-toggle elli" data-toggle="dropdown" aria-expanded="true">
                                 <i class="fa fa-ellipsis-v"></i> </a> 
                                <ul class="dropdown-menu pull-right">

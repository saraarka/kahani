    		...
    		<section class="content contentseries" style="padding:16px 16px 0px;">
    			<div style="display:flex; flex-wrap:wrap; justify-content:center;">
    				...
    				<div class="" style="width:800px;">
						<div class="box box-widget widget-user boxshv seriesaddtodrafts" style="padding:0px 25px 25px; height:470px;">
    						...
    						<div class="row">
    							...
    							<div class="col-md-12">
        							<div class="box-body pad" style="margin-top:0px;padding-top: 0px;">
        								<textarea name="story" id="story" onclick="addseriesepisode(<?php echo $row->sid;?>)" class="draftsave" placeholder="Enter Series Story Here...." required style="resize:none;"><?php echo set_value('story');?></textarea>

            ...
            <div class="" style="display:flex; flex-wrap:wrap;justify-content:center;">
        		<div class="side1">
        				...
        				<div class="sideimg sidebarvj" style="box-shadow: 0 1px 3px 0 rgba(0,0,0,.2), 0 1px 1px 0 rgba(0,0,0,.14), 0 2px 1px -1px rgba(0,0,0,.12); overflow:visible;">
            				<div class="header">
        					    ...
        					    <center>
        					        <button class="btn-block btn btn-success unjoin<?php echo $this->uri->segment(2);?>" onclick="commuunjoin(<?php echo $this->uri->segment(2);?>,'<?php echo $communitie_about;?>')"> JOINED </button>
        					    </center>
            				</div>
        				</div>
        		        <br>
        				...
        				<div class="tab-content" style="padding:0px;background: #ecf0f5;">
        					...
        					<div class="tab-pane" id="about" style="padding:10px;background:#fff;">
        						<?php if(isset($get_communities_adout) && !empty($get_communities_adout)){
        							...
        							<div>
        								<img src="<?php echo base_url();?>assets/images/<?php echo $row->comm_image; ?>" alt="Community Image" class="img-responsive" style="width:584px; height:190px;">
        								<br><br>
        								<p class="text-justify"><?php echo $row->about_communities; ?></p>
        							</div>
        						<?php } } ?>
        					</div>
        					<!-- /.tab-pane -->
        						...
        						<div class="box-header with-borders">
        							<div class="user-block">
        								<a>
        									...
        									<?php } else { ?>
        										<img src="<?php echo base_url();?>assets/images/2.png" class="img-circle" alt="<?php echo $this->session->userdata['logged_in']['name'];?>">
        									<?php } ?>
        									</span>
        								</a>
        								...
        								<div class="box box-widget" style="border:1px solid #dddddd;margin-bottom:10px;display:none;" id="previewdiv">
        									<div class="box-header with-borders">
        										<div class="user-block">
        										    ...
        										    <?php }else{ ?>
        										        <img class="img-circle" src="<?php echo base_url();?>assets/images/2.png" alt="<?php echo $this->session->userdata['logged_in']['name'];?>">
        										    <?php } ?>
        										    </span>
        											<span class="username">
            											...
            											<?php foreach($comments->result() as $comment) { ?>
            												<div class="box-footer box-comments editdelete<?php echo $comment->id;?>">
            													<div class="box-comment">
            														...
            														<?php } ?>
            														<div class="comment-text">
            															<span class="username" style="padding-top:6px;">&nbsp; <b><?php echo ucfirst($comment->name);?></b>
            															    <span class="dropdown" style="float:right;">
                                                                                <a href="javascript:void(0);" class="dropdown-toggle elli" data-toggle="dropdown" aria-expanded="true">
                                                                                 <i class="fa fa-ellipsis-v"></i> </a> 
                                                                                <ul class="dropdown-menu pull-right">
            													...
            													<div class="topsubcomments" id="topmysubList<?php echo $key->id;?>_<?php echo $comment->id;?>" style="margin-bottom:10px;">
                													<?php $topsubcomments = get_subcomments($key->id, $comment->id); 
                    													...
                    													<div class="media editdelete<?php echo $topsubcomment->id;?>" style="margin-bottom:15px;">
                													        ...
                													        <span class="media-body bodycv">
                													            <div class="">
                    													            <span class="">&nbsp;<b><?php echo ucfirst($topsubcomment->name);?></b>
                    													                <span class="dropdown" style="float:right;">
            												...
            												<div class="box-footer box-comments editdelete<?php echo $comment->id;?>">
            													<div class="box-comment">
            														...
            														<div style="margin:8px 0 6px 2px" class="comment-text">
            															...
            															<div style="margin:5px 0;" class="">
                                                                            <a href="javascript:void(0)" onClick="toppostReplycomment(<?php echo $comment->id;?>,<?php echo $comment->comm_id;?>,<?php echo $comment->story_id;?>)" class="pull-left replycv" title="Reply">REPLY</a> 
                                                                            <a href="javascript:void(0)" onClick="toppostdisplayreplies(<?php echo $comment->id;?>,<?php echo $comment->comm_id;?>,<?php echo $comment->story_id;?>)" class="pull-left replycv" title="Replies">| <?php echo get_subcmtcount($comment->id);?> REPLIES</a>
                                                                        </div>
            														</div><br>
            														<div class="comment-text">
            														    <div class="input-group toppostreplycomment<?php echo $comment->id;?>" style="margin-bottom:5px;"><!-- Reply comment form --></div>
            													...
            													<div class="topsubcomments" style="margin-bottom:10px;display:none;" id="topmysubList<?php echo $key->id;?>_<?php echo $comment->id;?>">
                													<?php $topsubcomments = get_subcomments($key->id, $comment->id); 
                													    if(isset($topsubcomments) && ($topsubcomments->num_rows() > 0)){ foreach($topsubcomments->result() as $topsubcomment){ ?>
                													        <div class="media editdelete<?php echo $topsubcomment->id;?>" style="padding-left:10px;">
        		...
        		<div class="side3">
        			<div class="sidebarvj" style="box-shadow: 0 1px 3px 0 rgba(0,0,0,.2), 0 1px 1px 0 rgba(0,0,0,.14), 0 2px 1px -1px rgba(0,0,0,.12);">
        				...
        				<?php $i = 0; if(isset($get_communities_all) && !empty($get_communities_all)){
        				foreach($get_communities_all->result() as $row) { if((!in_array($row->id, $join_comm)) && ($i < 10)) { ?>
        				<div class="row pt-0">
        					<div class="col-md-12 pd-0" style="padding-left:5px;">
        					    <span class="pull-left" style="padding-top:8px;">
        					        <a href="" style="text-transform:uppercase; padding-top:10px; text-overflow:ellipsis;"><b><?php echo $row->gener; ?></b></a>
                ...
                <div class="row">
                    <?php if(isset($comm_joines) && ($comm_joines->num_rows() >0)){ foreach($comm_joines->result() as $comm_joinie){ ?>
                        <div class="user-block" style="padding:0 10px; display:flex;">
            		        ...
            		        <?php } else{ ?>
            		            <a href="<?php echo base_url();?>profile?id=<?php echo $comm_joinie->user_id;?>">
            		                <img class="img-circle" src="<?php echo base_url();?>assets/images/2.png" alt="<?php echo ucwords($comm_joinie->username);?>">
            		            </a>
            		        <?php } ?>
            		       </span>
        		        
        		        <span  class="username" style="padding-top:8px;width:52%;margin-left:2px;">
        		            <span style="color:#337ab7;font-size:16.2px;"><?php echo ucwords($comm_joinie->username);?></span>
						</span>
		...
		$.post("<?php echo base_url();?>index.php/welcome/communities_comments",inputdata,function(resultdata, status) {
			...
			if(result.status == -1){
				...
				$('.ajaxcomment'+story_id).prepend('<div class="box-comment">'+
    		        '<img class="img-circle" src="<?php echo base_url();?>assets/images/2.png" alt="'+result.response.name+'">'+
                                    ...
                                    var htmlcomment ='<div class="media editdelete'+result.response[0].cid+'" style="padding-bottom:0px;padding-left:10px;">'+
									    '<span class="media-left"><img class="img-circle" src="<?php echo base_url();?>assets/images/'+profile_image+'" alt="'+result.response[0].name+'" style="width:25px;"></span>'+
                                            '<span class="media-body bodycv"><span class="username"> &nbsp;'+result.response[0].name+
                                                ...
                                                '</span>'+
                                                '<span class="text-muted pull-right datecv">1 minute ago</span></span>'+
                                                '<span class="more '+result.response[0].id+'" style="padding-left:6px; word-break:break-word;">'+result.response[0].comment+'</span>'+
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                if(result.response){
                                    ...
                                    var htmlcomment ='<div class="media editdelete'+result.response[0].cid+'" style="margin-bottom:15px;padding-bottom:0px;">'+
									    '<span class="media-left"><img class="img-circle" style="width:25px;" src="<?php echo base_url();?>assets/images/'+profile_image+'" alt="'+result.response[0].name+'"></span>'+
                                            '<span class="media-body bodycv"><span class=""> &nbsp;'+result.response[0].name+
                                                '<span class="dropdown" style="float:right;">'+
                                                    '<a href="javascript:void(0);" class="dropdown-toggle elli" data-toggle="dropdown" aria-expanded="true" style="padding: 0px 10px 0px 20px;">'+
                                                     '<i class="fa fa-ellipsis-v"></i> </a> '+
                                                    '<ul class="dropdown-menu pull-right">'+

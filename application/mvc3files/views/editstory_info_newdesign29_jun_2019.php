...
<form action="<?php echo base_url();?>updatestory_info/<?php echo $sid;?>" id="display_result" method="post" name="registration" enctype="multipart/form-data">
			    ...
			    <?php if(isset($story_info) && ($story_info->num_rows() == 1)){ foreach($story_info->result() as $storyrow) { ?>
				    <div class="hidec" style="margin-bottom:20px; width:293px;">
    						...
    						<label class="btn-default" style="background:none;width:293px; cursor:pointer;" for="upload-file-selector">
    							<div class="box box-widget widget-user boxshv" style="height: 280px; width:293px;">
    								...
    								<span class="upload-file-selector">
    									...
    									<img src="<?php echo base_url();?>assets/images/<?php echo $storyrow->cover_image; ?>" style="width:293px; height:280px;" class="imageThumb" alt="<?php echo $storyrow->title;?>">
    								    <?php } else{ ?>
    								    <img src="<?php echo base_url();?>assets/images/series-stories.jpg" style="width:293px; height:280px;" class="imageThumb" alt="<?php echo $storyrow->title;?>">
    								    <?php } ?>
						...
						<div class="row" style="width:293px;">
            				<div class="box box-default boxshv" style="border:none;width:293px;">
							...
							<div class="row">
								<div class="box-body form-horizontal">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control" id="title" name="title" placeholder="Title" required value="<?php echo $storyrow->title;?>">
										    <span class="text-danger"><?php echo form_error('title');?></span>
										</div>
									</div>
									<?php if(isset($storyrow->language) && ($storyrow->language != 'en')){ ?>
									<div class="form-group" id="etitlestyle">
										<label for="" class="col-sm-3 control-label">Title in English :</label>
										<div class="col-sm-8">
											<input type="text" class="form-control" id="etitle" name="etitle" placeholder="Re-Enter Title in English" required value="<?php echo $storyrow->etitle;?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control" id="tags-input" name="keywords" placeholder="Key words related to your story" value="<?php echo $storyrow->keywords;?>">

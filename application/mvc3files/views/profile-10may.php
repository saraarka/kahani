    		                        		...
    		                        		<?php $i = 0; foreach($writernanos->result() as $wnanorow) { if($i < 3){ ?>
    		                        			<div class="nano-stories">
    		                        				<div>
                        								...
                        								<?php }else{ ?>
                        									<img src="<?php echo base_url();?>assets/default/series-stories.jpg" class="circle-image" style="height:50px;" alt="<?php echo $wnanorow->name;?>">
                        								<?php } ?>
        ...
        function loadResults(pcmtllimit, pcmtlstart) {
            ...
            $.ajax({
                ...
                success:function(data){
                    $("#commentresults").append(data);
                    if(data == '') {
                        $('#pcmtl_data_message').html("<center><div class='col-md-12' style='padding-top:20px;'> No More Results!</div></center>");
                        pcmtlaction = 'active';
                    }else{
                        $('#pcmtl_data_message').html("<center><div class='col-md-12' style='padding-top:20px;'> Loading ...</div></center>");

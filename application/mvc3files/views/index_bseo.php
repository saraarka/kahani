	...
	<section class="content" style="padding-bottom:0;">
		        ...
		        <div id="StoryContyn" class="StoryCont" style="text-align:left;">
    				...
    				<?php foreach($yournetworks->result() as $yournetwork) { ?>
    					<div class="card">
    						...
    						<a href="<?php echo base_url('only_story_view?id='.$yournetwork->sid);?>">
    						...
    						<div>
    							<font class="max-lines">
    								<a href="<?php echo base_url('only_story_view?id='.$yournetwork->sid);?>" class="product-title"><?php echo $yournetwork->title;?></a>
    							</font> 
    						</div>
    						<div class="flextest">
    							<font class="byname">By<font class="namehere"><a href="<?php echo base_url('profile?id='.$yournetwork->user_id);?>" style="color:#000"><?php echo $yournetwork->name;?></a></font>
    						    </font><br>
    						</div>
    				...
    				<?php } if($yournetworks->num_rows() >= 7){ ?>
    					<div class="card" style="justify-content: center">   
    						<font class="max-lines" style="padding-left:52px" >
    						    <a href="<?php echo base_url();?>viewallyournetwork">VIEW MORE</a>
    						</font>
    					</div>
    				<?php } ?>
    				</div>
		        ...
		        <div id="StoryConta" class="StoryCont" style="text-align:left;">
    				...
    				<?php foreach($adminchoices->result() as $adminchoice) { ?>
    					<div class="card">
    						...
    						<a href="<?php echo base_url('only_story_view?id='.$adminchoice->sid);?>">
    						...
    						<div>
    							<font class="max-lines">
    								<a href="<?php echo base_url('only_story_view?id='.$adminchoice->sid);?>" class="product-title"><?php echo $adminchoice->title;?></a>
    							</font> 
    						</div>
    						<div class="flextest">
    							<font class="byname">By<font class="namehere"><a href="<?php echo base_url('profile?id='.$adminchoice->user_id);?>" style="color:#000"><?php echo $adminchoice->name;?></a></font>
    						    </font><br>
    						</div>
    						<div class="flextest" style="padding-top:4px;">
    							<font class="episodes">
		...
		<div class="main-container">
		    ...
		    <?php if(isset($top_get_series) && ($top_get_series->num_rows() > 0)){ $divisioncount = $divisioncount + $top_get_series->num_rows(); ?>
    		    <div class="titleindex" style="clear:both;">
    		    	...
    		    	<a href="<?php echo base_url();?>topviewallhome/series">
    		    	    <span class="view pull-right">VIEW MORE</span>
		    	    </a>
    		    	<?php } ?>
    		    </div><hr>
				    ...
				    <div id="story-slider" class="story-slider series">
        				<?php foreach($top_get_series->result() as $topseriesrow) { ?>
        					<div class="card">
        						...
        						<div class="flextest">
        							<font class="byname">By<font class="namehere"><a href="<?php echo base_url('profile?id='.$topseriesrow->user_id);?>" style="color:#000"><?php echo $topseriesrow->name;?></a></font>
        							</font><br>
        						</div>
        						<div class="flextest" style="padding-top:4px;">
        							<font class="episodes">
        			    ...
        			    <?php } if($top_get_series->num_rows() >= 7){ ?>
        					<div class="card" style="justify-content: center">   
        						<font class="max-lines" style="padding-left:52px" >
        						    <a href="<?php echo base_url();?>topviewallhome/series">VIEW MORE</a>
        						</font>
        					</div>
    					<?php } ?>
				    </div>
		...
		<div class="main-container">
		    <?php if(isset($get_series) && ($get_series->num_rows() > 0)){ $divisioncount = $divisioncount + $get_series->num_rows(); ?>
    			<div class="titleindex" style="clear:both;">
    		    	...
    		    	<a href="<?php echo base_url();?>viewallhome/series">
    		    	    <span class="view pull-right">VIEW MORE</span>
    		    	</a>
    		    	<?php } ?>
    		    </div><hr>
    				...
    				<div id="story-sliderls" class="story-slider">
    					<?php foreach($get_series->result() as $seriesrow) { ?>
    						<div class="card">
    							...
    							<a href="<?php echo base_url('new_series?id='.$seriesrow->sid.'&story_id='.$seriesrow->story_id);?>">
    							...
    							<div class="flextest">
    								<font class="byname">By<font class="namehere"><a href="<?php echo base_url('profile?id='.$seriesrow->user_id);?>" style="color:#000"><?php echo $seriesrow->name;?></a></font>
    								</font><br>
    							</div>
    							<div class="flextest" style="padding-top:4px;">
    								<font class="episodes">
    					...
    					<?php } if($get_series->num_rows() >= 7) { ?>
    						<div class="card" style="justify-content: center">   
    							<font class="max-lines" style="padding-left:52px" >
    							    <a href="<?php echo base_url();?>viewallhome/series">VIEW MORE</a>
    							</font>
    						</div>
    					<?php } ?>
    				</div>
		...
		<div class="main-container">
			...
			<div class="titleindex" style="clear:both;">
    			...
    			<a href="<?php echo base_url();?>topviewallhome/story">
    			    <span class="view pull-right">VIEW MORE</span>
    			</a>
    			<?php } ?>
    		</div><hr>
				...
				<div id="StoryContts" class="StoryCont" style="text-align:left;">
					...
					<?php foreach($top_get_storys->result() as $topstorysrow) { ?>
						<div class="card">
							...
							<a href="<?php echo base_url('only_story_view?id='.$topstorysrow->sid);?>">
							...
							<div>
								<font class="max-lines">
									<a href="<?php echo base_url('only_story_view?id='.$topstorysrow->sid);?>" class="product-title">
									    <?php echo $topstorysrow->title;?>
									</a>
								</font> 
							</div>
							<div class="flextest">
								<font class="byname">By<font class="namehere"><a href="<?php echo base_url('profile?id='.$topstorysrow->user_id);?>" style="color:#000"><?php echo $topstorysrow->name;?></a></font>
							    </font><br>
							</div>
							<div class="flextest" style="padding-top:4px;">
								<font class = "episodes">
					...
					<?php } if($top_get_storys->num_rows() >= 7){ ?>
						<div class="card" style="justify-content: center">   
							<font class="max-lines" style="padding-left:52px" >
							    <a href="<?php echo base_url();?>topviewallhome/story">VIEW MORE</a>
							</font>
						</div>
					<?php } ?>
					</div>
		...
		<div class="main-container">
		    ...
		    <div class="titleindex" style="clear:both;">
    			...
    			<a href="<?php echo base_url();?>viewallhome/story">
    			    <span class="view pull-right">VIEW MORE</span>
    			</a>
    			<?php } ?>
    		</div><hr>
		        ...
		        <div id="StoryConttsl" class="StoryCont" style="text-align:left;">
    				...
    				<?php foreach($get_storys->result() as $storysrow) { ?>
    					<div class="card">
    						...
    						<a href="<?php echo base_url('only_story_view?id='.$storysrow->sid);?>">
    						...
    						<div>
    							<font class="max-lines">
    								<a href="<?php echo base_url('only_story_view?id='.$storysrow->sid);?>" class="product-title">
    								    <?php echo $storysrow->title;?>
    								</a>
    							</font> 
    						</div>
    						<div class="flextest">
    							<font class="byname">By<font class="namehere"><a href="<?php echo base_url('profile?id='.$storysrow->user_id);?>" style="color:#000"><?php echo $storysrow->name;?></a></font>
    						    </font><br>
    						</div>
    						<div class="flextest" style="padding-top:4px;">
    							<font class="episodes">
    				...
    				<?php } if($get_storys->num_rows() >= 7){ ?>
    					<div class="card" style="justify-content: center">   
    						<font class="max-lines" style="padding-left:52px" >
    						    <a href="<?php echo base_url();?>viewallhome/story">VIEW MORE</a>
    						</font>
    					</div>
    				<?php } ?>
    				</div>
		...
		<?php if(isset($top_get_life) && ($top_get_life->num_rows() > 0)){ $divisioncount = $divisioncount + $top_get_life->num_rows(); ?>
    		<div class="titleindex" style="clear:both;">
    			...
    			<a href="<?php echo base_url();?>topviewallhome/life">
    			    <span class="view pull-right">VIEW MORE</span>
    			</a>
    			<?php } ?>
    		</div><hr>
		    <div id="StoryContl" class="StoryCont" >
				<div id="story-sliderl" class="story-slider" >
					<?php $i=0; foreach($top_get_life->result() as $topliferow) { if($i < 5){?>
						<div class="card1">
							<a href="<?php echo base_url('only_story_view?id='.$topliferow->sid);?>">
    							<?php if(isset($liferow->image) && !empty($liferow->image)) { ?>
    								<img src="<?php echo base_url();?>assets/images/<?php echo $liferow->image; ?>" alt="<?php echo $topliferow->title;?>" class="imageme1">
    							<?php }else{ ?>
							...
							<div class="flextest">
								...
								<?php } else { ?>
									<font class="byname">By<font class="namehere"><a href="<?php echo base_url('profile?id='.$topliferow->user_id);?>" style="color:#000"><?php echo $topliferow->name;?></a>
									    </font>
								    </font><br>
								<?php } ?>
							</div>
							<div class="flextest" style="padding-top:4px;">
								<font class="lifeEvents-text"><?php echo $topliferow->story;?> 
									<a href="<?php echo base_url('only_story_view?id='.$topliferow->sid);?>"></a>
								</font>
							</div>
							<div class="flextest" style="padding-top:6px">
					...
					<?php } $i++;}if($top_get_life->num_rows() >= 5) { ?>
						<div class="card1" style="justify-content: center">   
							<font class="max-lines" style=" text-align:center;" >
							    <a href="<?php echo base_url();?>topviewallhome/life">VIEW MORE</a>
							</font>
						</div>
					<?php } ?>
				</div>
		...
		<div class="main-container">
	        ...
	        <div class="titleindex" style="clear:both;">
    			...
    			<a href="<?php echo base_url();?>viewallhome/life">
    			    <span class="view pull-right">VIEW MORE</span>
    			</a>
    			<?php } ?>
    		</div><hr>
		    <div id="StoryContll" class="StoryCont" >
			    <div id="story-sliderll" class="story-slider" >
						...
						<div class="card1">
							...
							<div class="flextest">
								<?php if(($liferow->writing_style == 'anonymous') && ($liferow->type == 'life')){ ?>
									<font class="byname">By<font class="namehere">Anonymous</font></font><br>
								<?php } else { ?>
									<font class="byname">By<font class="namehere"><a href="<?php echo base_url('profile?id='.$liferow->user_id);?>" style="color:#000"><?php echo $liferow->name;?></a>
									    </font>
									</font><br>
								<?php } ?>
							</div>
					...
					<?php } $i++; } if($get_life->num_rows() >= 5){ ?>
						<div class="card1" style="justify-content: center">   
							<font class="max-lines" style=" text-align:center;" >
							    <a href="<?php echo base_url();?>viewallhome/life">VIEW MORE</a>
							</font>
						</div>
					<?php } ?>
				</div>
		...
		<div class="main-container">
			...
			<div class="titleindex" style="clear:both;">
    			...
    			<a href="<?php echo base_url();?>viewallhome/nano">
    			    <span class="view pull-right">VIEW MORE</span>
    			</a>
    			<?php } ?>
    		</div><hr>
		    <div id="StoryContn" class="StoryCont">
				<div id="story-slidern" class="story-slider">
						...
						<div class="nano-stories">
							<div>
								...
								<h3 class="name-nanostories">
								    <a href="<?php echo base_url('profile?id='.$nanorow->user_id);?>" style="color:#000"><?php echo $nanorow->name;?></a>
								</h3>
							</div>
							<div>
							...
							<div class="lastdiv">
								...
								<?php if(isset($this->session->userdata['logged_in']['user_id'])){
    							    ...
    							    <font>
    								    <span class="nanolikecount<?php echo $nanorow->sid;?>"><?php echo $nanorow->nanolikecount;?></span>
    								    <a href="javascript:void(0);" onclick="nanolike(<?php echo $nanorow->sid;?>);" class="notloginmodal" title="like">
    										<i class="fa fa-heart-o favbtn<?php echo $nanorow->sid;?>" style="color:#f00; padding-top:5px;"></i>
    									</a>
    								</font>
    							<?php } ?>
					...
					<div class="nano-stories" style="justify-content: center">   
						<font class="max-lines" style=" text-align:center;" >
						    <a href="<?php echo base_url();?>viewallhome/nano">VIEW MORE</a>
						</font>
					</div>
					<?php } ?>
				</div>
    					...
    					<div class="modal-header">
    						<div class="">
    							...
    							<h3 class="name-nanostories" style="margin-top: -40px; margin-left: 50px;">
    							    <a href="<?php echo base_url('profile?id='.$nanomodalrow->user_id);?>" style="color:#000"><?php echo $nanomodalrow->name;?></a>
    	            ...
    	            <div id="story-sliderw" class="story-slider" >
    	            	<?php foreach($get_writer->result() as $writerrow) { ?>
    	            		<div class="card1" style="height:215px">
    	            		    <?php if(isset($writerrow->banner_image) && !empty($writerrow->banner_image)){ $bannerimage = $writerrow->banner_image; 
    	            		        }else if(isset($writerrow->profile_image) && !empty($writerrow->profile_image)){ $bannerimage = $writerrow->profile_image;
    	            		        }else{ $bannerimage = '1.jpg'; } ?>
    					        <div class="imageme1" style="height:115px; background-position:center; background:url(<?php echo base_url();?>assets/images/<?php echo $bannerimage; ?>) center center; background-size:cover">
    						        <div style="padding:9px; background:rgba(0, 0, 0, 0.64);height:115px;">
    						            <a href="<?php echo base_url('profile?id='.$writerrow->user_id);?>">
        						            <?php if(isset($writerrow->profile_image) && !empty($writerrow->profile_image)) { ?>
        						            	<img src="<?php echo base_url();?>assets/images/<?php echo $writerrow->profile_image; ?>" alt="Avatar" class="circle-image" alt="<?php echo $writerrow->name;?>" style="height:50px">
        						            <?php }else{ ?>
        						            	<img src="<?php echo base_url();?>assets/default/life.jpg" alt="Avatar" class="circle-image" alt="<?php echo $writerrow->name;?>" style="height:50px">
        						            <?php } ?>
    						            </a>
    						            <h3 class="name-nanostories" style="color:#fff">
    						                <a href="<?php echo base_url('profile?id='.$writerrow->user_id);?>" style="color:#FFF;"><?php echo $writerrow->name;?></a>
    						            </h3>
						...
						<div class="card1" style="justify-content: center">   
							<font class="max-lines" style=" text-align:center;" >
							    <a href="<?php echo base_url();?>">VIEW MORE</a>
							</font>
						</div>
					<?php } ?>
    	            </div>
	    ...
	    <!--<div class="main-container">
	        <div class="footer" style="position:fixed;bottom:40px;width:inherit;">
                <font style="float:left;font-size: 18px;margin-top: 8px;margin-left:10px;font-family: 'Varela Round', sans-serif;" class="copyright">
            ...
            <div class="footer1 bottom_f" style="position:fixed;bottom:0px;width:inherit;">
                <div style="font-size:14px;color:black;font-family: 'Varela Round', sans-serif;">
                    <center>

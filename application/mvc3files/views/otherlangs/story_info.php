...
<form action="<?php echo base_url($this->uri->segment(1).'/story_info_uplode') ?>" id="display_result" method="post" name="registration" enctype="multipart/form-data">
...
<script>
    $(document).ready(function(){
        $("#cancel").click(function(){
            ...
            if(type == 'series'){
                location.href = "<?php echo base_url().$this->uri->segment(1);?>/admin-series/"+title.replace(/\s+/g, '-')+'-'+sid+'/'+title.replace(/\s+/g, '-')+'-'+storyid;
            }else{

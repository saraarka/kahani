...
function fbLogout() {
    FB.logout(function() {
        ...
        location.href = "<?php echo base_url().$this->uri->segment(1);?>/logout";
    });
}
...
function getFbUserData(){
    ...
    function (response) {
        ...
        $.ajax({
			url: "<?php echo base_url().$this->uri->segment(1);?>/checkfacebooklogin",
			type: 'POST',
			...
			success: function (resultdata) {
				if((resultdata.status == 1) && (resultdata.lresponse == 'gotologin') && (resultdata.userid)){
                    $.ajax({
            			url: "<?php echo base_url().$this->uri->segment(1);?>/facebooklogin",
            			type: 'POST',
...
<script>
    function onSignIn(googleUser) {
		...
		$.ajax({
			url: "<?php echo base_url().$this->uri->segment(1);?>/checkgooglelogin",
			type: 'POST',
			...
			success: function (resultdata) {
				if((resultdata.status == 1) && (resultdata.lresponse == 'gotologin') && (resultdata.userid)){
                    $.ajax({
            			url: "<?php echo base_url().$this->uri->segment(1);?>/googlelogin",
            			type: 'POST',

...
<form action="<?php echo base_url().$this->uri->segment(1);?>/story_story_uplode" id="display_result" method="post" name="registration" enctype="multipart/form-data">
	<div class="navbar navbar-inverse navbar-static-top contentseries" role="navigation" id="" style="margin-bottom:0px;  background-color:#23678e;">	
    	<div class="navbar-collapse">
    		<ul class="nav navbar-nav pull-right">
			    ...
			    <li class="">
        			<a href="<?php echo base_url().$this->uri->segment(1);?>" style="background:none;color:#FFF;font:bold;border-color:#3c8dbc;"> CANCEL </a>
			    </li>
    		</ul>
    	</div>
    </div>
		...
		<section class="content contentseries">
			<div style="display:flex; justify-content:center;">
				    <div class="hidec" style="margin-bottom:20px; width:293px;">
					    <div class="row">
							<label class="btn-default" style="background:none;width:320px;cursor:pointer;" for="upload-file-selector">
							...
							<div class="row">
								<div class="box-body form-horizontal">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
										    <div class="custom-select"> 
											    <select class="" name="genre" required="">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
										    <div class="custom-select">
										    	<select class="" name="copyrights" required="">
...
<script>
    $('input[name="pay_story"]').click(function() {
        ...
        if(paystoryval == 'Y'){
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>index.php/welcome/storymonitizeradio",

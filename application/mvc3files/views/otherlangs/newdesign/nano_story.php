...
<form action="<?php echo base_url($this->uri->segment(1).'/nano_insert');?>" method="post" id="nanostory">
    <div class="navbar navbar-inverse navbar-static-top contentseries" role="navigation" id="" style="margin-bottom:0px;  background-color:#23678e;">	
    	<div class="navbar-collapse">
    		<ul class="nav navbar-nav pull-right">
			    ...
			    <li class="">
        			<a href="<?php echo base_url().$this->uri->segment(1);?>" class="" style="background:none;color:#FFF;font:bold;border-color:#3c8dbc;"> CANCEL </a>
			    </li>
    		</ul>
    	</div>
    </div>
        			    ...
        			    <div class="box box-widget widget-user boxshv" style="padding:25px;"><br>
        					<div class="row">	
        						...
        						<div class="box-body pad">
        							...
        							<textarea name="story" id="story" rows="15" cols="96" required="" class="form-control" placeholder="Start Writing Here...." maxlength="1000" style="resize:none;"><?php echo set_value('story');?></textarea>

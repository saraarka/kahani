        ...
        <div id="StoryContv1" class="StoryCont1" style="text-align:left;">
            ...
            <?php foreach($rlseries->result() as $rlseriesrow){ ?>
            	<div class="card">
        			...
        			<a href="<?php echo base_url($this->uri->segment(1).'/series/'.preg_replace("~[^\p{M}\w]+~u", '-', $rlseriesrow->title).'-'.$rlseriesrow->sid.'/'.preg_replace("~[^\p{M}\w]+~u", '-', $rlseriesrow->title).'-'.$rlseriesrow->story_id);?>" class="imagess-style">
        ...
        <div id="StoryCont2s" class="StoryCont1" style="text-align:left;">
            <div id="story-slider2s" class="story-slider series">
                ...
                <div class="card">
        			...
        			<a href="<?php echo base_url($this->uri->segment(1).'/story/'.preg_replace("~[^\p{M}\w]+~u", '-', $rlstoryrow->title).'-'.$rlstoryrow->sid);?>" class="imagess-style">

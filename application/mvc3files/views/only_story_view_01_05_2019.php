    			...
    			<li class="">
                    ...
                    if(isset($readlatersids) && (sizeof($readlatersids)>0) && in_array($_GET['id'], $readlatersids)) { ?>
    					<a class="btn btn-primary readlaterbtn<?php echo $_GET['id'];?>" style="background: none; border: none;">
    					    <button style="background:none; border:none; padding:0;color:#fff;" onclick="unreadlater(<?php echo $_GET['id'];?>)" class="notloginmodal readlaterbtnatr<?php echo $_GET['id'];?>">
    			            <i class="fa fa-check faicon<?php echo $_GET['id'];?>"></i> READ LATER</button>
    			        </a>
            	    <?php } else { ?>
                        <a class="btn btn-primary readlaterbtn<?php echo $_GET['id'];?>" style="background: none; border: none;">
        			        <button style="background:none; border:none; padding:0;color:#fff;" onclick="readlater(<?php echo $_GET['id'];?>)" class="notloginmodal readlaterbtnatr<?php echo $_GET['id'];?>">
    			...
    			<li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right">
                        <li onclick="groupsuggest(<?php echo $row->sid; ?>);">
            				<a data-toggle="modal" data-target="#groupsuggest" title="COMMUNITY"><i class="fa fa-users"></i> COMMUNITY</a>
            			</li>
            			<li onclick="friend(<?php echo $row->sid;?>);">
            				<a data-toggle="modal" data-target="#friendsuggest" title="SUGGEST"><i class="fa fa-user"></i> SUGGEST</a>
            			</li>
    					<li>

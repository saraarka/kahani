                ...
                <div class="row pt-0">
		            <div class="col-md-12 pd-0">
		                ...
		                <?php if(isset($clientp->banner_image) && !empty($clientp->banner_image)){ ?>
	                        <div class="widget-user-header ovv  profile1 bgvv" style="background: url('<?php echo base_url();?>assets/images/<?php echo $clientp->banner_image; ?>')center center;background-repeat: no-repeat; background-size: auto;background-size: cover; padding:0px;">
	                            <div style="background-color:rgba(0, 0, 0, 0.55); background-repeat: no-repeat;background-size: cover; padding: 80px 30px; height: 250px;">
					                <div class="widget-user-image">
    					             ...
    					             <h3 class="widget-user-username clrvk" style="color:#fff; margin-left:100px;"><b><a href="<?php echo base_url().$clientp->profile_name;?>" style="color:#fff;"><?php echo $clientp->name;?> </a></b></h3>
        												...
        												<div class="box-header with-border">
        													<div class="row" style="margin:0 -10px;">
            													...
            													<?php } } else { ?>
														            <center> 
														                <div class="" style="margin:19.8% auto;">
														                    <h3> You do not following anyone </h3>
														                </div>
														            </center>
                   									            <?php } ?>
        													</div>
            ...
            <div class="" style="display:flex; flex-wrap:wrap; text-justify:center;">
    			...
    			<div class="main-container1">
					...
					<div class="tab-content">
				                        	...
				                        	<div class="card">
    				                    		...
    				                    		<div class="flextest">
    				                    			<font class="byname">By<font class="namehere">
    				                    			    <a href="<?php echo base_url($wseriesrow->profile_name);?>" style="color:#000;"><?php echo $wseriesrow->name;?></a></font></font><br>
    				                    		</div>
                       ...
                       <!--  ------------------------------------------------------ -->
                        <div class="tab-pane" id="tab_reading"><div style="margin-top:50px;"><center><img src="<?php echo base_url();?>/assets/landing/svg/spinnertab.svg" class="spinner"></center></div></div><!-- tab2-content -->

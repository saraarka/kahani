    ...
    <body>
        <div class="write-nav">
            ...
            <div class="nav-items-write">
                ...
                <div><button type="submit" class="start-writing-btn" onclick="submit()"> UPDATE </button></div>
        ...
        <div class="infocontainer">
            <div class="info">
                <?php if(isset($story) && ($story->num_rows() > 0)){
                    ...
                    <form action="<?php echo base_url('nano_update');?>" method="post" id="display_result">
                        ...
                        <input type="hidden" name="nanosid" value="<?php echo $storyrow->sid;?>">
                        <div class="formgroup">
                            ...
                            <select name="language" required="" id="languageDropDown" onchange="javascript:languageChangeHandler()">
                                ...
                                if($key->code == $sesslang){ ?>
                                <option value="<?php echo $key->code; ?>"><?php echo $key->language; ?></option>
                                <?php } } } ?>
                            </select>
                        ...
                        <div class="display: flex;">
                            ...
                            <h6 class="pull-left" id="count_message"><?php echo strlen($storyrow->story);?></h6>
                        </div>
                        <textarea class="storywrite" id="story" name="story" placeholder="Start Writing Here...." maxlength="1000" minlength="1" required=""><?php echo $storyrow->story;?></textarea>
                    </form>
                <?php } } ?>
            </div>
        </div>
...
<script>
    var text_max = 1000-parseInt($('#count_message').text());

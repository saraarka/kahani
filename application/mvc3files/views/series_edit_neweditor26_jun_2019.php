    ...
    <div style="" class="content contentseries">
        <div style="display:flex; justify-content:center;">
			    <div class="hidec" style="margin-bottom:20px; width:293px;">
    				<div class="row">
    				    <label class="btn-default" style="background:#fff;" for="upload-file-selector">
				            <div class="box box-widget widget-user boxshv" style="height: 280px; width:293px;">
    				            <?php if(isset($row->cover_image) && !empty($row->cover_image)) { ?>
        				            ...
        				            <span class="upload-file-selector">
        				                <center>
        				                    <img src="<?php echo base_url();?>assets/images/<?php echo $row->cover_image; ?>" class="imageThumb" style="height:280px;width:293px;" alt="<?php echo $row->title; ?>">
        				                </center>
			    ...
			    <div class="side-ed">
        			<div class="box box-widget widget-user boxshv editor-series">
						...
						<div class="box-body" style="padding:0px 10px;">
						    <center><h2 style="padding-top:20px;padding-bottom:20px; margin:0"><b>
        		                <input type="text" name="title" placeholder="Enter Title" required="" class="form-control" style="border:none;text-align:center;font-size: 24px;padding:0px;color:#000" value="<?php echo $row->title;?>">
        					</b></h2></center>
        				</div>
						...
						<div class="pad">
							...
							<textarea id="story" name="story" rows="18" class="storywritev form-control" style="resize:none;"><?php if(isset($row->draft_story) && !empty($row->draft_story)){echo $row->draft_story;}else{echo $row->story;}?></textarea>

									...
									<div class="box-header with-border">
										<div class="user-block">
											...
											<span class="pull-right">
												<a href="#" class="dropdown-toggle" data-toggle="dropdown" title="Click Here to Report" aria-expanded="false">
													<i class="fa fa-ellipsis-v pull-right"></i>
												</a>
												<ul class="dropdown-menu dv1">
													<li><a href="#" onclick="reportcomm_post(<?php echo $key->id;?>, <?php echo $key->user_id;?>)"><i class="fa fa-exclamation-triangle"></i> Report </a></li>
												</ul>
											</span>
										...
										<div class="box-header with-border">
											<div class="user-block">
												...
												<?php } else { ?>
													<img class="img-circle" src="<?php echo base_url();?>assets/images/2.png" alt="User Image">
												<?php } ?>
												<span class="username"><a href="#"><?php echo $yourfeed->name;?></a>
													<?php if(isset($this->session->userdata['logged_in']['user_id']) && ($yourfeed->user_id == $this->session->userdata['logged_in']['user_id'])){ ?>
														...
														<ul class="dropdown-menu" style="float:right;right: 0;top: 24px;left:72%;">
															<li><a href="#" onclick="deletecomm_post(<?php echo $yourfeed->id;?>, <?php echo $yourfeed->user_id;?>)"><i class="fa fa-trash"></i> Delete </a></li>
															<li><a href="#" onclick="editcomm_post(<?php echo $yourfeed->id;?>, <?php echo $yourfeed->user_id;?>)"><i class="fa fa-pencil"></i> Edit </a></li>
														</ul>
													<?php } else { ?>
														<a href="#" class="dropdown-toggle" data-toggle="dropdown" title="write" aria-expanded="false">
															<i class="fa fa-ellipsis-v pull-right"></i>
														...
														<ul class="dropdown-menu" style="float:right;right: 0;top: 24px;left:72%;width:25%">
															<li><a href="#" class="" style="" onclick="reportcomm_post(<?php echo $yourfeed->id;?>, <?php echo $yourfeed->user_id;?>)"><i class="fa fa-exclamation-triangle"></i> Report </a>
															</li>
														</ul>
													<?php } ?>
												</span>
										...
										<div class="box-header with-border">
											<div class="user-block">
												...
												<?php } else { ?>
													<img class="img-circle" src="<?php echo base_url();?>assets/images/2.png" alt="User Image">
												<?php } ?>
												<span class="username"><a href="#"><?php echo $yourfeed->name;?></a></span>
												<span class="description"><?php echo get_ydhmdatetime($yourfeed->date);?></span>
											</div>
										</div>
										<div class="box-body">
						        ...
						        <div class="box box-widget" style="background:#fff; border:1px solid #dddddd;margin-bottom: 10px;">
						            <div class="box-header with-border">
										<div class="user-block">
											...
											<span class="username"><a href="#"><?php echo $storyfeed->name;?></a></span>
									...
									<div class="box-body">
										<div class="media border-box" style="margin-top:2px;">
											...
											<div class="media-body" style="padding-top:15px;">
												...
												<p class="edittext<?php echo $storyfeed->sid;?>"><?php echo substr($storyfeed->story,0,150);?>...</p>
											</div>
										</div>
									</div>
									<!-- /.box-footer -->
...
<script> 
    $(document).ready(function(){ // yourfeed auto scroll
        ...
        $(window).scroll(function(){
            if($(window).scrollTop() + $(window).height() > $("#yloadmoreall").height() && yaction == 'inactive'){
                yaction = 'active';
                ystart = ystart + ylimit;
                setTimeout(function(){yload_country_data(ylimit, ystart);}, 500);
            }
        });
    });
</script>
...
<script> 
    $(document).ready(function(){ // Stories feed auto scroll
        ...
        $(window).scroll(function(){
            if($(window).scrollTop() + $(window).height() > $("#sloadmoreall").height() && saction == 'inactive'){
                saction = 'active';
                sstart = sstart + slimit;
                setTimeout(function(){sload_country_data(slimit, sstart);}, 500);
            }
        });
    });
</script>

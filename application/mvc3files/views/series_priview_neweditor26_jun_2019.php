	...
	<div class="navbar-collapse">
		<ul class="nav navbar-nav pull-right">
		    ...
		    <li>
    			...
    			<!--<a href="<?php echo base_url();?>home" class="" style="background-color:#23678e;color:#FFF;font:bold;border-color:#3c8dbc;padding:7px 12px;"> CANCEL </a>-->
		    </li></ul>
	</div>
</div>
            	...
            	<div class="hidec" style="margin-bottom:20px; width:293px;">
    			    ...
    			    <div class="box box-widget widget-user boxshv" style="height: 280px; width:293px;">
					    <?php if(isset($row->cover_image) && !empty($row->cover_image)) { ?>
						    <img src="<?php echo base_url(); ?>assets/images/<?php echo $row->cover_image; ?>" style="height: 280px; width:293px; box-shadow: 0 1px 3px 0 rgba(0,0,0,.2), 0 1px 1px 0 rgba(0,0,0,.14), 0 2px 1px -1px rgba(0,0,0,.12);" alt="<?php echo $row->title;?>">
					    <?php }else{ ?>
					        <img src="<?php echo base_url(); ?>assets/default/series-stories.jpg" style="height: 280px; width:293px; box-shadow: 0 1px 3px 0 rgba(0,0,0,.2), 0 1px 1px 0 rgba(0,0,0,.14), 0 2px 1px -1px rgba(0,0,0,.12);" alt="<?php echo $row->title;?>">
					    <?php } ?>
					</div>
					</div>
    			</div>
    			<div class="side-ed">
    			    <div class="box box-widget widget-user boxshv editor-series">
        				<div class="row">
        					...
        					<div class="col-md-12">
        						<div class="box-body pad editor-series-e">
...
<script>
    /*$(document).ready( function() {
        ...
        tinyMCE.activeEditor.on('keypress keyup', function(ed, e) {
            ...
            var pay_story = $('input[name="pay_story"]:checked').val();
            $.ajax({
    			type: "POST",
                url: "<?php echo base_url();?>index.php/welcome/prefaceautosave",

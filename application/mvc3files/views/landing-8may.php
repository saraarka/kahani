					...
					<div class="">
					    <center>
					        <p class="text-centerv" style="margin:5px;">Don't have an account? 
					            <a href="#signupmodal" data-dismiss="modal" data-toggle="modal" data-target="#signupmodal" style="color:#0e92af">Sign Up</a>
					        </p>
...
<div class="modal fade modal-signup" id="signupmodal" role="dialog">

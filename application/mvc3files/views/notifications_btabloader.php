                                            ...
                                            <span class="username"><span> New episode </span>
                                                ...
                                                <?php $seriesuri = '#'; $seriestitle = '';
                                                    if(isset($storynotify->title_id) && !empty($storynotify->title_id)){ 
                                                        ...
                                                        $seriesuri='series/'.preg_replace('/\s+/', '-', $seriesname[0]->title).'-'.$seriesname[0]->sid.'/'.preg_replace('/\s+/', '-', $seriesname[0]->title).'-'.$seriesname[0]->story_id;
                                                        }
                                                    } ?>
...
<script>
    $(document).ready(function(){
        ...
        function tab2load_country_data(tab2limit, tab2start) {
            $.ajax({
                url:'<?php echo base_url();?>welcome/tab2loadnotifications',
                method:"POST",

    ...
    <div class="main">
        ...
        <form class="form-horizontal" action="<?php echo base_url();?>index.php/<?php echo $this->uri->segment(1);?>/updatehomeslide/<?php echo $editsliderow->id;?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="caption" class="form-control" placeholder="Enter caption on Slide" value="<?php echo $editsliderow->caption;?>">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3"><img src="<?php echo base_url().'assets/images/'.$editsliderow->slideimage;?>" style="height:60px;"></div>
            </div>
            
            <div class="form-group">
                <label class="control-label col-sm-2" for="slideurl">Slide URL: *</label>
                <div class="col-sm-10">
                    <input type="url" name="slideurl" class="form-control" placeholder="Enter URL to redirect" value="<?php echo $editsliderow->slideurl;?>">

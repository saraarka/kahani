                        ...
                        <div class="side1">
                            <div class="sideimg sidebarvj" style="border:1px solid #000; overflow:visible;">
                				<div class="header">
            					    ...
            					    <?php if(isset($comm_joines) && ($comm_joines->num_rows() >0)) { ?>
            					        ...
            					        <center>
    										<?php $imgcount = 1; foreach($comm_joines->result() as $comm_joinie) {
    											...
    											<a href="<?php echo base_url();?>profile?id=<?php echo $comm_joinie->user_id;?>"><span>
            					    ...
            					    <button class="btn-block btn btn-success unjoin<?php echo $this->uri->segment(2);?>" onclick="commuunjoin(<?php echo $this->uri->segment(2);?>,'<?php echo $communitie_about;?>')"> JOINED </button><br>
                				</div>
            				</div>
                        </div>
                							...
                							<div class="user-block">
                								<span class="img-u">
                									...
                									!empty($this->session->userdata['logged_in']['profile_image'])) { ?>
                										<img src="<?php echo base_url().'assets/images/'.$this->session->userdata['logged_in']['profile_image']; ?>" class="img-circle" alt="User Image">
                									<?php } else { ?>
                										<img src="<?php echo base_url();?>assets/images/2.png" class="img-circle">
                									<?php } ?>
                								</span>
                								...
                								<?php if(isset($communities_story_get) && ($communities_story_get->num_rows() > 0)){ ?><div id="loadposts">
                									...
                									<div class="box box-widget" style="background:#fff; border:1px solid #dddddd; margin-bottom:10px;" id="delcomm<?php echo $key->id;?>">        
                										...
                										<div class="box-body">
                											...
                											<?php } else { ?>
                												<p class="edittext<?php echo $key->id;?>"><i class="fa fa-quote-left fa-2x"></i> <span style="font-size:1.2em"><?php echo $key->story;?></span></p>
                											<?php } ?>
                										</div>
                										<div class="box-body">
                											...
                											<span class="pull-right text-muted">
                												...
                												<?php if(isset($comm_comment_count) && ($comm_comment_count->num_rows()>0)) {
                													foreach($comm_comment_count->result() as $reviews2) { 
                														if($reviews2->story_id == $key->id) { echo $reviews2->commentcount; }
                												} } ?> Comments
                											</span>
                										</div>
                										<?php } else { ?>
                											...
                											<div id="myList<?php echo $key->id;?>">
                    											<?php foreach($comments->result() as $comment){ ?>
                    												<div class="box-footer box-comments editdelete<?php echo $comment->id;?>" style="padding-bottom:0px;">
                    													<div class="box-comment">
                    														...
                    														<div style="margin:8px 0 6px 2px" class="comment-text">
                    															...
                    															<div style="margin:5px 0;" class="">
                                                                                    ...
                                                                                    <a href="javascript:void(0)" onClick="postReplycomment(<?php echo $comment->id;?>,<?php echo $comment->comm_id;?>,<?php echo $comment->story_id;?>)" class="pull-left replycv" title="Reply">| 0 REPLIES</a>
                                                                                </div>
                    														</div><br>
                    														<div class="comment-text">
                    													...
                    													<div class="subcomments" style="margin-bottom:10px;" id="mysubList<?php echo $key->id;?>_<?php echo $comment->id;?>">
                        													<?php $subcomments = get_subcomments($key->id, $comment->id); 
                            													...
                            													<div class="media editdelete<?php echo $subcomment->id;?>" style="padding-left:10px;">
                            													    <span class="media-left">
                            													        ...
                            													        <img class="img-circle" style="width:25px;" src="<?php echo base_url();?>assets/images/<?php echo $subcomment->profile_image;?>">
                            													        <?php } else { ?>
                            													    ...
                            													    <span class="media-body bodycv">
                            													        <div class=""><!--username-->
                            													            <span class="">&nbsp;<b><?php echo ucfirst($subcomment->name);?></b>
                                                                                                ...
                                                                                                <span class="text-muted pull-right" style="font-weight:300; font-size:0.9em;"><?php echo get_ydhmdatetime($subcomment->date);?></span>
                            													            </span>	<br> <span class="more <?php echo $subcomment->id;?>" style="padding-left:6px;"><?php echo $subcomment->comment;?></span>
                							...
                							<div class="col-md-12" style="padding:0">
                								...
                								<?php if(isset($communities_story_get_likes) && !empty($communities_story_get_likes)){ ?><div id="toploadposts">
                									...
                									<div class="box box-widget" style="background:#fff; border:1px solid #dddddd; margin-bottom:10px;">
                										...
                										<div class="box-footer">
                											<div id="tpostscommunity_commentpost<?php echo $key->id; ?>">
                												...
                												<div class="input-group">
                													...
                													<input type="hidden" name="tcomm_id" value="<?php echo $this->uri->segment(2); ?>">
                													<span class="input-group-btn">
                										...
                										<?php $comments = get_comments($key->id); 
                											if(isset($comments) && ($comments->num_rows()>0)) { ?>
                											<div id="topmyList<?php echo $key->id;?>">
                    											<?php foreach($comments->result() as $comment) { ?>
                    												<div class="box-footer box-comments editdelete<?php echo $comment->id;?>">
                    													<div class="box-comment">
                    														...
                    														<div style="margin:8px 0 6px 2px" class="comment-text">
                    															...
                    															<div style="margin:5px 0;" class="">
                                                                                    ...
                                                                                    <a href="javascript:void(0)" onClick="" class="pull-left replycv" title="Reply">| 0 REPLIES</a>
                                                                                </div>
        					                                                </div><br>
        					                                                <div class="comment-text">
                    													...
                    													<div class="topsubcomments" id="topmysubList<?php echo $key->id;?>_<?php echo $comment->id;?>" style="padding-left:10px;">
                        													<?php $topsubcomments = get_subcomments($key->id, $comment->id); 
                            													...
                            													<div class="media editdelete<?php echo $topsubcomment->id;?>" style="padding-bottom:0px;">
                            													    <span class="media-left">
                            													        <?php if(isset($topsubcomment->profile_image) && !empty($topsubcomment->profile_image)){ ?>
                            													        <img class="img-circle" style="width:25px;" src="<?php echo base_url();?>assets/images/<?php echo $topsubcomment->profile_image;?>">
                            													        <?php } else { ?>
                            													        <img class="img-circle" style="width:25px;" src="<?php echo base_url();?>assets/images/2.png" alt="User Image">
                            													        <?php } ?>
                            													   </span>
                    										    ...
                    										    <?php } ?> 
                										        <a href="javascript:void(0);"><span class="toploadmorespan<?php echo $key->id;?>" onClick="topcommloadmore(<?php echo $key->id;?>, <?php echo $comment->id;?>)"><center>Read More...</center></span></a>
                										    </div>
            											<?php } ?>
            									    </div>
            										<!-- /.box-footer -->
                    												...
                    												<div class="box-footer box-comments editdelete<?php echo $comment->id;?>">
                    													<div class="box-comment">
                    														...
                    														<div class="comment-text">
                                                                                ...
                                                                                <a href="javascript:void(0)" onClick="toppostReplycomment(<?php echo $comment->id;?>,<?php echo $comment->comm_id;?>,<?php echo $comment->story_id;?>)" class="pull-right replycv" title="Reply"><i class="fa fa-reply" aria-hidden="true"></i> REPLY</a>
                    															<div class="input-group toppostreplycomment<?php echo $comment->id;?>"><!-- Reply comment form --></div>
                    														</div>
                    													</div>
                    													<div class="topsubcomments" id="topmysubList<?php echo $key->id;?>_<?php echo $comment->id;?>">
                        													<?php $topsubcomments = get_subcomments($key->id, $comment->id); 
                        													    if(isset($topsubcomments) && ($topsubcomments->num_rows() > 0)){ foreach($topsubcomments->result() as $topsubcomment){ ?>
                    ...
                    <?php if(isset($comm_joines) && ($comm_joines->num_rows() >0)){ foreach($comm_joines->result() as $comm_joinie){
                        echo "<div class='col-md-12'>";
    					  if(!empty($comm_joinie->profile_image)){ ?>
    					    <a href="<?php echo base_url();?>profile?id=<?php echo $comm_joinie->user_id;?>">
    										...
    										<ul class="list-inline" style="padding:10px 10px; background: #eee;">
    											...
    											<li class="pull-right">
    											    <?php if(isset($following) && isset($this->session->userdata['logged_in']['user_id']) && ($comm_joinie->user_id == $this->session->userdata['logged_in']['user_id'])) { ?>
    											        <button class="btn btn-success" onclick="yoursfollow();" style="margin-top: -7px;"> FOLLOW </button>
						...
						<?php if(isset($following) && isset($this->session->userdata['logged_in']['user_id']) && ($comm_joinie->user_id == $this->session->userdata['logged_in']['user_id'])) { ?>
    				        <button class="btn btn-success pull-right" onclick="yoursfollow();"> FOLLOW </button>
        		        <?php }else if(isset($following) && in_array($comm_joinie->user_id, $following)) { ?>
...
<script type="text/javascript">
	$('#previewurl, #urldescription').keyup(function() {
		...
		var community_id = "<?php echo $this->uri->segment(2);?>";
		...
		$.ajax({
			...
			success: function(data) {
				if(data == 'wrongurl'){
				...
				}else if(data.indexOf("controllers/Welcome.php") > 0){
				    $('#previewdiv').css('display','block');
					$('#preview').html('<center><div class="text-danger">Please enter Valid URL.</div></center>');
				}else if((data.title) && (data.titleurl)) {
					...
					'<img src="'+posturlimage+'" class="media-object" style="height: 215px; width: 215px;"> </a> </div>'+
			...
			if(result.status == -1){
				...
				$('.ajaxcomment'+story_id).prepend('<div class="box-comment">'+
    			    ...
    			    '<div class="comment-text"><span class="username" style="padding-top:6px;">&nbsp; '+result.response.name+
                        ...
                        '<div style="margin:5px 0;" class=""><a href="javascript:void(0)" style="padding-right:8px; font-size:0.8em; color:red" onclick="postReplycomment('+result.response.id+','+result.response.comm_id+','+result.response.story_id+')" class="pull-left" title="Reply">REPLY</a> <a href="javascript:void(0)" style="font-size:0.8em;color:red;" onClick="" class="pull-left" title="Reply">| 0 REPLIES</a></div></div><br>'+
				...
				$('.tajaxcomment'+story_id).prepend('<div class="box-comment">'+
    			    ...
    			    '<div class="comment-text"><span class="username" style="padding-top:6px;">&nbsp;'+result.response.name+
    			        '<span class="pull-right">'+
                            ...
                            '</ul>'+
                        '</span>'+
    			        '<span class="text-muted pull-right" style="font-weight:300; font-size:0.9em;">1 minute ago</span></span>'+
    			    '</div>'+
    			    '<div style="margin:8px 0 6px 2px" class="comment-text">'+
    		            '<span class="more '+result.response.id+'">'+result.response.comment+'</span>'+
    		            '<div style="margin:5px 0;" class="">'+
                        '<a href="javascript:void(0)" style="font-size:0.8em;color:red;" onclick="toppostReplycomment('+result.response.id+','+result.response.comm_id+','+result.response.story_id+')" class="pull-left" title="Reply"> REPLY</a>'+
                        '<a href="javascript:void(0)" style="font-size:0.8em;color:red;" onClick="" class="pull-left" title="Reply">| 0 REPLIES</a>'+
                        '</div>'+
                    '</div><br>'+
                    '<div class="comment-text">'+
                        '<div class="input-group toppostreplycomment'+result.response.id+'" style="margin-bottom:5px;"></div>'+
    		        '</div>'+
    		    '</div>'+'<div class="topsubcomments" style="background:#ddd;" id="topmysubList'+result.response.story_id+'_'+result.response.id+'"></div>');
			}else{
				alert('Failed to Post Comment.');
			}
		})
    ...
    $( "form#posturlform" ).submit(function( event ) { //post url form
        ...
        $.post("<?php echo base_url();?>index.php/welcome/communities_story",$("form#posturlform").serialize(),function(resultdata) {
            if(resultdata == 'notvalid'){
                ...
                $('.notvalid').html(' ');
            }else if(resultdata.indexOf("controllers/Welcome.php") > 0){
				$('.notvalid').html('Please enter Valid URL.');
            }else{
                $('#previewdiv').html(' ');
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                if(result.response){
                                    ...
                                    var htmlcomment ='<div class="media editdelete'+result.response[0].cid+'" style="padding-bottom:0px;padding-left:10px;">'+
									    '<span class="media-left"><img class="img-circle" src="<?php echo base_url();?>assets/images/'+profile_image+'" alt="User Image" style="width:25px;"></span>'+
                                            '<span class="media-body" style="background:#ddd; padding:5px; border-radius:2px;"><span class="username"> &nbsp;'+result.response[0].name+
                                                '<span class="pull-right">'+
                                                    '<a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true" style="padding: 0px 10px 0px 20px;">'+
                                                     '<i class="fa fa-ellipsis-v"></i> </a> '+
                                                    '<ul class="dropdown-menu writemenu" style="top:auto; width:fit-content;">'+
                                                ...
                                                '</span>'+
                                                '<span class="text-muted pull-right" style="font-weight:300; font-size:0.9em;">1 minute ago</span></span>'+
                                                '<span class="more '+result.response[0].id+'" style="padding-left:6px;">'+result.response[0].comment+'</span>'+
                                ...
                                /*var htmlcomment = '<li style="margin-bottom:10px;" class="commentdelete'+result.response[0].cid+'">'+
                                    ...
                                    //$('div.postreplycmt'+result.response[0].comment_id).prepend(htmlcomment);*/
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                if(result.response){
                                    ...
                                    var htmlcomment ='<div class="media editdelete'+result.response[0].cid+'" style="padding-bottom:0px;">'+
									    '<span class="media-left"><img class="img-circle" style="width:25px;" src="<?php echo base_url();?>assets/images/'+profile_image+'" alt="User Image"></span>'+
                                            '<span class="media-body" style="background:#ddd; border-radius:2px; padding:5px;"><span class="username"> &nbsp;'+result.response[0].name+
                                                '<span class="pull-right">'+
                                                    '<a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true" style="padding: 0px 10px 0px 20px;">'+
                                                     '<i class="fa fa-ellipsis-v"></i> </a> '+
                                                    '<ul class="dropdown-menu writemenu" style="top:auto; width:fit-content;">'+
...
<script>
    $(document).ready(function(){
        ...
        function load_country_data(limit, start) {
            var commuid = "<?php echo $this->uri->segment(2);?>";
            $.ajax({
                url:'<?php echo base_url();?>index.php/welcome/loadcommustories/'+commuid,
                method:"POST",
...
<script>
    $(document).ready(function(){
        ...
        function tload_country_data(tlimit, tstart) {
            var commuid = "<?php echo $this->uri->segment(2);?>";
            $.ajax({
                url:'<?php echo base_url();?>index.php/welcome/toploadcommustories/'+commuid,
                method:"POST",

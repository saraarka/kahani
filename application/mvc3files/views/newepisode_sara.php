    						...
    						<div class="row">
    							...
    							<div class="col-md-12">
            						<div class="box-body pad editor-series-e">
        								...
        								<textarea name="story" id="story" onclick="addseriesepisode(<?php echo $row->sid;?>)"  class="storywritev draftsave" placeholder="Enter Series Story Here...." required style="resize:none;"><?php echo set_value('story');?></textarea>

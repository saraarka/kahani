...
@media screen and (max-width: 620px){
  ...
  <div class="main">
    ...
    <div class="scblogs">
      ...
      <?php if(isset($genderusers) && count($genderusers > 0)){ ?>
        <h3>Users Count</h3>
          <div class="tagpagemaindiv">
              <?php foreach($genderusers as $genderuser) { ?>
                  <div class="tagcards">
                      <div class="tagtext"><a href="javascript:void(0);">
                        <?php if($genderuser['gender'] == ''){
                          echo 'Not Changed'; 
                        }else{ 
                          echo $genderuser['gender'];
                        } ?></a></div>
                      <div class="tagnumbertext"><?php echo $genderuser['usercount'];?></div>
                  </div>
              <?php } ?>
          </div>
      <?php } ?>

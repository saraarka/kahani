...
if( marLeftts < -maxXts ){ 
  ...
  slideContts.animate({"margin-left" : marLeftts + "px"}, 500);
}
...
if( marLefttsl < -maxXtsl ){ 
  ...
  slideConttsl.animate({"margin-left" : marLefttsl + "px"}, 500);
}
...
if( marLeftyn < -maxXyn ){ 
  ...
  slideContyn.animate({"margin-left" : marLeftyn + "px"}, 500);
}
...
if( marLefta < -maxXa ){ 
  ...
  slideConta.animate({"margin-left" : marLefta + "px"}, 500);
}

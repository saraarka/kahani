                ...
                <div class="language-div">
                    ...
                    <div class="language-box">
                        <?php if(isset($languages) && ($languages->num_rows() > 0)){ foreach($languages->result() as $language){ ?>
                            <a href="<?php echo base_url();?>english/<?php echo $language->code; ?>">
    ...
    <div class="footer1">
        <div style="font-size:14px;color:black;font-family: 'Varela Round', sans-serif;">
            <center>
                ...
                <font class="hover-tems"><a href="<?php echo base_url();?>privacy_policy">PRIVACY</a></font>
            </center>
        </div>
    </div>  <!-- footer end -->
				...
				<div class="login-box-body">
					...
					<form id="loginform" action="#" method="POST" style="margin-bottom: 0;">
					    <div class="input-container has-feedback">
                            ...
                            <input class="input-field" type="email" placeholder="Email" name="email" id="email" autocomplete="off">
                        </div>
			...
			<div class="modal-body">
				...
				<div class="login-box-body">
					...
					<form id="signup" action="#" method="POST" style="margin-bottom: 0;">
                        ...
                        <div class="row" style="margin-top:5px;">
							<div class="col-xs-12">
								<center><button type="submit" class="btn bg-green" style="cursor:pointer;">Sign Up</button></center>
							</div>
						</div>
					</form>
			...
			<div class="modal-body">
				...
				<form id="choosecommu" method="POST" style="margin-bottom: 0;">
    				<div class="login-box-body" style="margin-top:20px; max-height:256px; overflow-y:scroll;">
						...
						<?php if(isset($gener) && ($gener->num_rows() > 0)) { foreach($gener->result() as $generrow) { ?>
							<label class="btn-default community-btn choosecomm" id="<?php echo $generrow->id;?>" style="padding:6px 2px;">
								<input type="checkbox" class="checkbox<?php echo $generrow->id;?>" style="float:left; display:none;" name="choosecomm[]" value="<?php echo $generrow->id;?>" style="visibility:hidden; color:white;"><?php echo $generrow->gener; ?>
							</label>
						<?php } } ?>
        				</div>
    				</div>
    				<div style="margin-top:18px;">
    				    <center>
    				        <button type="submit" class="btn-next choosecommsave" style="color:#bcb2b2; background:#eee;width:82px;"> NEXT </button>
    				    </center>
    				</div>
    				<!--<div style="margin-top:18px;">
    				    <center>

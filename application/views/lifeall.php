		    ...
		    <div class="row pt-0">
		    	...
		    	<div class="col-md-6 col-xs-4 pd-0">
		    		<div class="view pull-right">
		    		   <a href="<?php echo base_url();?>lifeevents/top">View More</a> 
		    		</div>
		    	</div>
		    	<?php } ?>
		    </div><hr>
							...
							<div class="flextest">
								...
								<?php } else { ?>
									<font class="byname">By <font class="namehere">
									    <a href="<?php echo base_url().$topliferow->profile_name; ?>" style="color:#000 !important;"><?php echo $topliferow->name;?></a></font></font>
									<br>
								<?php } ?>
							</div>
					...
					<div class="card2">
						<a href="<?php echo base_url('story/'.preg_replace("~[^\p{M}\w]+~u",'-', $liferow->title).'-'.$liferow->sid);?>" class="imagelife-style">
							...
							<div class="flextest">
								...
								<?php } else { ?>
									<font class="byname">By <font class="namehere">
									    <a href="<?php echo base_url().$liferow->profile_name; ?>" style="color:#000 !important;"><?php echo $liferow->name;?></a></font></font>
									<br>
								<?php } ?>
							</div>
...
<script>
    $(document).ready(function(){
        ...
        function load_country_data(limit, start) {
            $.ajax({
                url:'<?php echo base_url();?>welcome/viewallloadmore/life',
                method:"POST",

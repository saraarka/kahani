    	...
    	<div class=""><!-- container-fluid-->
            <div class="main-container">
                <div class="" style="display:flex; flex-wrap:wrap;justify-content:center;">
            		...
            		<div class="side2">
            		    <!--
            		    <div class="box-footer box-comments" style="background: rgb(255, 255, 255); display: block;">
            		        <div class="box-comment">
            		            <img class="img-circle" src="https://www.storycarry.com/assets/images/4452d7f404468a030170acc694f18081.jpg" alt="suresh">
            		            <div class="comment-text">
            		                <span class="username" style="padding-top:6px;">&nbsp; suresh
            		                    <span class="dropdown pull-right"><a href="javascript:void(0);" class="dropdown-toggle elli" data-toggle="dropdown" aria-expanded="true">
            		                        <i class="fa fa-ellipsis-v"></i> </a>
            		                        <ul class="dropdown-menu pull-right">
            		                            <li><a href="javascript:void(0);" onclick="editcommcomment(1248);"><span><i class="fa fa-pencil"></i> EDIT</span></a></li>
            		                            <li><a href="javascript:void(0);" onclick="deletecommcomment(1248);"><span><i class="fa fa-trash"></i> DELETE</span></a></li>
            		                        </ul>
            		                    </span>
            		                    <span class="text-muted pull-right" style="font-weight:300; font-size:0.9em;">1 minute ago</span>
            		                </span>
            		            </div>
            		            <div style="margin:8px 0 6px 2px" class="comment-text">
            		                <div class="more 1248">hiohiohohho</div>
            		                <div style="margin:5px 0;" class="">
            		                    <a href="javascript:void(0)" style="padding-right:8px; font-size:0.8em; color:red" onclick="postReplycomment(1248,20,238)" class="pull-left" title="Reply">REPLY</a>
            		                    <a href="" class="pull-left replycv">I</a>
            		                    <a href="javascript:void(0)" style="font-size:0.8em;color:red;" onclick="displayreplies(1248,20,238)" class="pull-left" title="Reply"><span class="old_subcmtcount1248">0</span> REPLIES</a>
            		                </div>
            		            </div><br>
                		        <div class="comment-text">
                		            <div class="input-group">
                		                ...
                		                <span class="input-group-btn">
            							    <button type="submit" class="btn btn-success btn-flat" onclick=""> Comment </button>
            							</span>
                		            </div>
                		        </div>
                		    </div>
            		        <div class="subcomments" style="margin-left:10px;" id="mysubList238_1248"></div>
                        </div>
                        <br>
            		    <!-- Ref code -->
                											...
                											<?php foreach($comments->result() as $comment) { ?>
                												<div class="box-footer box-comments editdelete<?php echo $comment->id;?>">
                													...
                													<div class="topsubcomments" style="margin-bottom:10px;display:none;" id="topmysubList<?php echo $key->id;?>_<?php echo $comment->id;?>">
                    													<?php $topsubcomments = get_subcomments($key->id, $comment->id); 
                    													    if(isset($topsubcomments) && ($topsubcomments->num_rows() > 0)){ foreach($topsubcomments->result() as $topsubcomment){ ?>
                    													        <div class="media editdelete<?php echo $topsubcomment->id;?>">
			...
			if(result.status == -1){
				...
				$('.ajaxcomment'+story_id).prepend('<div class="box-comment">'+
    			    ...
    			    '<div class="comment-text"><span class="username" style="padding-top:6px;">&nbsp; '+result.response.name+
                        ...
                        '<div style="margin:5px 0;" class=""><a href="javascript:void(0)" style="padding-right:8px; font-size:0.8em; color:red" onclick="postReplycomment('+result.response.id+','+result.response.comm_id+','+result.response.story_id+')" class="pull-left" title="Reply">REPLY</a>'+
                        '<a href="" class="pull-left replycv">I</a> <a href="javascript:void(0)" style="font-size:0.8em;color:red;" onClick="displayreplies('+result.response.id+','+result.response.comm_id+','+result.response.story_id+')" class="pull-left" title="Reply"><span class="old_subcmtcount'+result.response.id+'">0</span> REPLIES</a></div></div><br>'+
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                if(result.response){
                                    ...
                                    var htmlcomment ='<div class="media editdelete'+result.response[0].id+'" style="padding-left:10px;">'+
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                if(result.response){
                                    ...
                                    var htmlcomment ='<div class="media editdelete'+result.response[0].id+'" style="margin-bottom:10px;">'+
									    '<span class="media-left"><img class="img-circle" src="<?php echo base_url();?>assets/images/'+profile_image+'" alt="'+result.response[0].name+'" style="width:25px;"></span>'+
                                            '<span class="media-body bodycv"><span class="username"> &nbsp;'+result.response[0].name+
                                                '<span class="dropdown" style="float:right;">'+
                                                    '<a href="javascript:void(0);" class="dropdown-toggle elli" data-toggle="dropdown" aria-expanded="true">'+

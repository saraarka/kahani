					...
					<?php if(isset($row->keywords) && !empty($row->keywords) && ($row->type == 'life')){ 
					    ...
					    <div class="" style="padding:10px; margin:15px 0;">
					        Tags: <?php foreach($noofkeywords as $keyword){ ?>
    						    <a style="margin-bottom:10px;margin-right: 7px; border-radius: 3px; border: 1px solid #00000052; padding: 7px 7px; color: #8a8a8a;display:inline-flex;" href="<?php echo base_url().$this->uri->segment(1);?>/searchresult?type=life&searchtext=<?php echo $keyword;?>"><?php echo $keyword;?></a>
    						<?php } ?>
					    </div>
					<?php } ?>
					<div class="clearfix"></div>
                                ...
                                <?php foreach ($recentstorieslife->result() as $recentlife) { ?>
                                    <div class="card1">
                                        ...
                                        <div class="flextest">
                                            ...
                                            <?php } else { ?>
                                                <font class="byname">By<font class="namehere">
                                                    <a href="<?php echo base_url().$this->uri->segment(1).'/'.$recentlife->profile_name;?>" style="color:#000;"> <?php echo $recentlife->name;?></a>
                                                </font></font><br>
                                            <?php } ?>
                                        </div>
                                        <div class="flextest" style="padding-top:4px;">
						 ...
						 <div class="vjbs" id="commentv" style="padding:10px;background: #fff; margin-top:50px">
					    	...
					    	<div class="box-footer box-comments">
					    		<div class="box-comment">
    								...
    								<div class="input-group hidden-xs ctext">

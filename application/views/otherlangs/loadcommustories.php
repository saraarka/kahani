    						...
    						<?php $subcomments = get_subcomments($key->id, $comment->id); 
    							...
    							<div class="media editdelete<?php echo $subcomment->id;?>" style="padding-left:10px;">
    							    ...
    							    <span class="media-body bodycv">
    							        <div class=""><!--username-->
    							            <span class="">&nbsp;<b>
    							                <a href="<?php echo base_url().$this->uri->segment(1).'/'.$subcomment->profile_name; ?>">
		...
		<div class="box-footer">
			<div id="tpostscommunity_commentpost<?php echo $topkey->id; ?>">
				...
				<div class="input-group">
					...
					<span class="input-group-btn">
						<button type="submit" class="btn btn-success btn-flat btnspinner<?php echo $topkey->id;?>" onclick="tpostscomm_comments(<?php echo $topkey->id;?>)"> Comment </button>
					</span>
				</div>
			</div>
		</div>

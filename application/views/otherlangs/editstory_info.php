...
<html lang="en">
    ...
    <body>
        ...
        <form action="<?php echo base_url().$this->uri->segment(1);?>/updatestory_info/<?php echo $sid;?>" onsubmit="return validateForm()" name="infoForm" method="post" enctype="multipart/form-data">
            <div class="write-nav">
            ...
            <div class="infocontainer">
                ...
                <?php if(isset($story_info) && ($story_info->num_rows() == 1)){ foreach($story_info->result() as $storyrow) { ?>
                    <div class="imagemaindiv">
                        <div class="imagebox">
                            <label for="upload-file-selector">
                                ...
                                <span class="upload-file-selector">
                                    <?php if(isset($storyrow->cover_image) && !empty($storyrow->cover_image)) { ?>
                                    <img src="<?php echo base_url();?>assets/images/<?php echo $storyrow->cover_image;?>" alt="<?php echo $storyrow->title;?>" class="imageThumb">
                                    <?php } else { ?>
                        ...
                        <div class="monetize">
                            ...
                            <div style="margin-left: 10px">
                                ...
                                <label>
                                    <input type="radio" name="pay_story" value="Y" <?php if(isset($storyrow->pay_story) && ($storyrow->pay_story == 'Y')){ echo 'checked'; } ?>> Yes
                                </label>
                                <label style="padding-left:15px;">
                                    <input type="radio" name="pay_story" value="N" <?php if(isset($storyrow->pay_story) && ($storyrow->pay_story == 'N')){ echo 'checked'; } ?>> No
                                </label>
                    ...
                    <div class="info">
                        <div id='translControl'>
                            <input type="hidden" name="language" id="languageto" value="<?php if(isset($storyrow->language) && !empty($storyrow->language)){ echo $storyrow->language; }else{ echo 'en'; } ?>">
                            <input type="hidden" id="checkboxId" checked="checked">
                        </div>
                        
                        <div class="formgroup"> 
                            <label for="title">ENTER TITLE : </label>
                            <input type="text" id="title" name="title" value="<?php echo $storyrow->title;?>" placeholder="Enter your story title" style="border: 1px solid #ccc;" autocomplete="off">
                            <span class="text-danger vtitle"><?php echo form_error('title');?></span>
                        </div>
                        
                        <?php if(isset($storyrow->language) && ($storyrow->language != 'en')){ ?>
                        <div class="formgroup" id="etitlestyle">
                            ...
                            <input type="text" id="etitle" name="etitle" value="<?php echo $storyrow->etitle;?>" placeholder="Re-enter your story title in english" style="border: 1px solid #ccc;" autocomplete="off">
                        ...
                        <div class="formgroup"> 
                            ...
                            <select name="genre" id="gener" required="">
                                ...
                                <?php if(isset($gener) && ($gener->num_rows()>0)){ foreach($gener->result() as $key) { ?>
                                    <option value="<?php echo $key->id; ?>" <?php if($key->id == $storyrow->genre){ echo 'selected';} ?>><?php echo $key->gener; ?></option>
                                <?php } } ?>
                            </select>
                        ...
                        <div class="formgroup"> 
                            ...
                            <select name="copyrights" id="copyrights" required="">
                                ...
                                <option value="All rights reserved" <?php if($storyrow->copyrights == 'All rights reserved'){ echo 'selected';} ?>>All rights reserved</option>
                                <option value="Attribution CC BY" <?php if($storyrow->copyrights == 'Attribution CC BY'){ echo 'selected';} ?>>Attribution CC BY</option>
                                <option value="Attribution-ShareAlike CC BY-SA" <?php if($storyrow->copyrights == 'Attribution-ShareAlike CC BY-SA'){ echo 'selected';} ?>>Attribution-ShareAlike CC BY-SA</option>
                                <option value="Attribution-NonCommercial CC BY-NC" <?php if($storyrow->copyrights == 'Attribution-NonCommercial CC BY-NC'){ echo 'selected';} ?>>Attribution-NonCommercial CC BY-NC</option>
                                <option value="Attribution-NonCommercial-ShareAlike CC BY-NC-SA" <?php if($storyrow->copyrights == 'Attribution-NonCommercial-ShareAlike CC BY-NC-SA'){ echo 'selected';} ?>>Attribution-NonCommercial-ShareAlike CC BY-NC-SA</option>
                                <option value="Attribution-NonCommercial-NonDerivs CC BY-NC-ND" <?php if($storyrow->copyrights == 'Attribution-NonCommercial-NonDerivs CC BY-NC-ND'){ echo 'selected';} ?>>Attribution-NonCommercial-NonDerivs CC BY-NC-ND</option>
                            </select>
                        ...
                        <div class="formgroup">
                            ...
                            <input type="text" class="form-control" id="tags-input" name="keywords" value="<?php echo $storyrow->keywords;?>" placeholder="Key words related to your story">

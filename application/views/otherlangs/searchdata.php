    		        ...
    		        <div id="StoryCont" class="StoryCont1" style="text-align:left;">
    				    ...
    				    <?php $i=0; foreach($get_storys->result() as $storysrow) { if($i<4){  ?>
    				    	<div class="card">
        						...
        						<div>
        							<font class="max-lines">
        								<a href="<?php echo base_url($this->uri->segment(1).'/story/'.preg_replace("~[^\p{M}\w]+~u", '-', $storysrow->title).'-'.$storysrow->sid);?>" style="color: #337ab7;">
                    	...
                    	<div id="story-sliderl" class="story-slider">
                    		<?php foreach($get_life->result() as $liferow) { ?>
                    			<div class="card1">
                    				...
                    				<div>
                    				<font class="max-lines">
                    					<a href="<?php echo base_url($this->uri->segment(1).'/story/'.preg_replace("~[^\p{M}\w]+~u", '-', $liferow->title).'-'.$liferow->sid);?>" style="color: #337ab7;">

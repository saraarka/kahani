                			...
                			<div class="card">
        						...
        						<div>
        							<font class="max-lines">
        								<a href="<?php echo base_url($this->uri->segment(1).'/series/'.preg_replace("~[^\p{M}\w]+~u", '-', $seriesrow->title).'-'.$seriesrow->sid.'/'.preg_replace("~[^\p{M}\w]+~u", '-', $seriesrow->title).'-'.$seriesrow->story_id);?>" style="color: #337ab7;">
    			    ...
    			    <div class="mg-2">
    				    ...
    				    <?php foreach($searchresults->result() as $storyrow) { ?>
    				    	<div class="card">
        						...
        						<div>
        							<font class="max-lines">
        								<a href="<?php echo base_url($this->uri->segment(1).'/story/'.preg_replace("~[^\p{M}\w]+~u", '-', $storyrow->title).'-'.$storyrow->sid);?>" style="color: #337ab7;">
                ...
                <?php } else if(isset($searchresults) && ($searchresults->num_rows() > 0) && ($_GET['type'] == 'life')){ ?>
                    ...
                    <div style="display:flex; flex-wrap:wrap; justify-content:center;" id="loadmoreall">
        			    ...
        			    <div class="card1">
            				...
            				<div>
            				<font class="max-lines">
            					<a href="<?php echo base_url($this->uri->segment(1).'/story/'.preg_replace("~[^\p{M}\w]+~u", '-', $liferow->title).'-'.$liferow->sid);?>" class="imagelife-style" style="color: #337ab7;">

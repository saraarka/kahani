            				...
            				<div class="tab-content">
            					...
            					<div class="tab-pane active" id="post">
            						...
            						<div class="box-footer">
            							...
            							<?php if($sesslang != 'en'){ ?>
        								<div style="margin-top: -45px;position: relative; border-collapse: separate;top:9px" class="desktopedit hidden-xs hidecommswitch">
            								...
            								<div class="box box-widget" style="border:1px solid #dddddd;margin-bottom:10px;display:none;" id="previewdiv">
            									<div class="box-header with-borders">
            										<div class="user-block">
            											...
            											<span class="username">
    														<a href="javascript:void(0);"><?php echo $this->session->userdata['logged_in']['name'];?> </a>
    													</span>
                    													...
                    													<?php $subcomments = get_subcomments($key->id, $comment->id); 
                        													...
                        													<div class="media editdelete<?php echo $subcomment->id;?>" style="padding-left:10px; margin-top:5px;margin-bottom:5px;">
                        													    ...
                        													    <span class="media-body bodycv">
                        													        <div class="">
                        													            <span class="username">&nbsp;<a href="<?php echo base_url().$this->uri->segment(1).'/'.$subcomment->profile_name; ?>">
                        													                <p class="namers"><?php echo ucfirst($subcomment->name);?></p></a>
            ...
            if(result.status == -1){
				...
				$('.tajaxcomment'+story_id).prepend('<div class="box-comment">'+
    			    ...
    			    '<div style="margin:8px 0px 6px 2px" class="comment-text">'+
    		            ...
    		            '<div style="" class="">'+
                        '<a href="javascript:void(0)" style="font-size:0.8em;color:red;" onclick="toppostReplycomment('+result.response.id+','+result.response.comm_id+','+result.response.story_id+')" class="pull-left" title="Reply"> REPLY</a> <a href="javascript:void(0);" class="pull-left replycv">I</a>'+

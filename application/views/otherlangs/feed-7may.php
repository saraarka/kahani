								...
								<div class="box box-widget" style="background:#fff; border:1px solid #dddddd;margin-bottom: 10px;" id="delcomm<?php echo $key->id;?>">
									<div class="box-header with-border">
										<div class="user-block">
											...
											<span class="username"><a href="<?php echo base_url().$this->uri->segment(1).'/'.$key->profile_name; ?>"><?php echo $key->name;?></a></span>
									...
									<?php if(isset($key->type) && ($key->type=='url')) { ?>
											...
											<?php if(!empty($key->title)){ ?>
												<div class="media border-box" style="margin-top:2px;">
													...
													<div class="media-body" style="padding-top:15px;">
														...
														<p class="media-heading edittext<?php echo $key->id;?>"><?php echo substr(strip_tags($key->story),0,150);?>...</p>
													</div>
												</div>
											<?php } else { ?>
										...
										<div class="box-body">
											...
											<?php } ?>
											<span style="padding-left:5px;"><a data-toggle="modal" data-target="#soc" href="javascript:void(0);"><i class="fa fa-share"></i> Share</a></span>
												...
												<div class="box-footer box-comments editdelete<?php echo $comment->id;?>" style="padding-bottom:0px;">
													<div class="box-comment">
														...
														<div class="comment-text">
															<span class="username" style="padding-top:6px;">&nbsp; <a href="<?php echo base_url().$this->uri->segment(1).'/'.$comment->profile_name; ?>"><?php echo ucfirst($comment->name);?></a>
    													...
    													<?php $subcomments = get_subcomments($key->id, $comment->id); 
        													...
        													<div class="media editdelete<?php echo $subcomment->id;?>" style="padding-left:10px;">
        													   ...
        													   <span class="media-body bodycv">
        													        <div class=""><!--username-->
        													            <span class="">&nbsp;<b><a href="<?php echo base_url().$this->uri->segment(1).'/'.$subcomment->profile_name; ?>"><?php echo ucfirst($subcomment->name);?></a></b>
        													                <span class="dropdown pull-right">
            													    ...
            													    <span class="media-body bodycv">
        													            <div class="">
            													            <span class="">&nbsp;<b><a href="<?php echo base_url().$this->uri->segment(1).'/'.$topsubcomment->profile_name; ?>">
            													                    <?php echo ucfirst($topsubcomment->name);?></a></b><span class="dropdown" style="float:right;">
						            ...
						            <div class="box-header with-border">
										<div class="user-block">
											...
											<span class="description"><a href="<?php echo base_url().$this->uri->segment(1).'/community/'.$storyfeed->gener; ?>">
											    <i style="color:#040cff;"><?php echo $storyfeed->gener;?></i></a> - <?php echo get_ydhmdatetime($storyfeed->created_at);?></i></span>
										</div>
									</div>
									<div class="box-body">
										<div class="media border-box" style="margin-top:2px;">
									    ...
									    foreach($fscomments->result() as $fscomment){ ?>
											<div class="box-footer box-comments fscommentdelete<?php echo $fscomment->cid;?>" style="padding-bottom:0px;">
												<div class="box-comment">
													...
													<?php } ?>
													<div class="comment-text">
														<span class="username" style="padding-top:6px;">&nbsp; <a href="<?php echo base_url().$this->uri->segment(1).'/'.$fscomment->profile_name; ?>"><?php echo ucfirst($fscomment->name);?></a>
															<span class="dropdown" style="float:right;">
                                                                <a href="javascript:void(0);" class="dropdown-toggle elli" data-toggle="dropdown" aria-expanded="true">
                                                                    <i class="fa fa-ellipsis-v"></i> </a> 
                                                                <ul class="dropdown-menu pull-right">
												...
												<div class="subcomments" style="display:none;" id="fsmysubList<?php echo $storyfeed->sid;?>_<?php echo $fscomment->cid;?>">
													<?php $fssubcomments = get_replaycomments($fscomment->story_id, $fscomment->cid, 2); 
    													...
    													<div class="media fscommentdelete<?php echo $fssubcomment->cid;?>" style="padding-bottom:0px;margin-bottom:10px;">
													        ...
													        <span class="media-body bodycv">
    													        <div class=""><!--username-->
    													            <span class="">&nbsp; <a href="<?php echo base_url().$this->uri->segment(1).'/'.$fssubcomment->profile_name; ?>"><?php echo ucfirst($fssubcomment->name);?> </a>
    													                <span class="dropdown pull-right">
                                                                            <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true" style="padding: 0px 10px 0px 20px;">
                                                                             <i class="fa fa-ellipsis-v"></i> </a> 
                                                                            <ul class="dropdown-menu pull-right">
...
function comm_comments(story_id){ //Comments post submit
	...
	$.post("<?php echo base_url().$this->uri->segment(1);?>/communities_comments",inputdata,function(resultdata, status) {
		...
		if(result.status == -1){
			...
			$('.ajaxcomment'+story_id).prepend('<div class="box-footer box-comment">'+
...
function tpostscomm_comments(story_id){ //top posts Comments post submit
	...
	$.post("<?php echo base_url().$this->uri->segment(1);?>/communities_comments",inputdata,function(resultdata, status) {
		...
		if(result.status == -1){
			...
			var yourfeedcommenthtml = '<div class="box-footer box-comments editdelete'+result.response.id+'"><div class="box-comment">'+
			    '<img class="img-circle" src="<?php echo base_url();?>assets/images/'+profile_image+'" alt="'+result.response.name+'">'+
			        '<div class="comment-text"><div class="comment-text"><span class="username">&nbsp; <b>'+result.response.name+'</b>'+
			            '<span class="dropdown" style="float:right;">'+
                            '<a href="javascript:void(0);" class="dropdown-toggle elli" data-toggle="dropdown" aria-expanded="true">'+
                              '<i class="fa fa-ellipsis-v"></i> </a> '+
                            '<ul class="dropdown-menu pull-right">'+
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                if(result.response){
                                    ...
                                    var yourfeedsubcommenthtml = '<div class="media editdelete'+result.response[0].id+'" style="margin-bottom:10px;">'+
	...
	function storyfeed(sid){ //Comments post submit
		...
		$.post("<?php echo base_url().$this->uri->segment(1);?>/fscomment",{'comment':comment,'storyid':sid},function(resultdata, status) {
			...
			if(result.status == -1){
				...
				$('.fsajaxcomment'+sid).prepend('<div class="box-footer box-comments fscommentdelete'+result.response.cid+'" style="padding: 0px;">'+

...
/*Left*/
    ...
    <div class="login dropdown profile">
		...
		<ul class="dropdown-menu pull-right">
			<li style="border-bottom:1px solid #f4f4f4;"><a href="<?php echo base_url($this->uri->segment(1)."/".$profilename); ?>" class="dropk"><i class="fa fa-user pr-10"></i> 
			    <?php if(isset($headmenus['my_profile']) && !empty($headmenus['my_profile'])){ echo $headmenus['my_profile']; }else{ ?> MY PROFILE <?php } ?> </a></li>
            <li style="border-bottom:1px solid #f4f4f4;"><a href="<?php echo base_url().$this->uri->segment(1);?>/my_profile/<?php echo $this->session->userdata['logged_in']['user_id'];?>" class="dropk"><i class="fa fa-sliders pr-10"></i> 
                <?php if(isset($headmenus['settings']) && !empty($headmenus['settings'])){ echo $headmenus['settings']; }else{ ?> SETTINGS <?php } ?> </a></li>
            <li style="border-bottom:1px solid #f4f4f4;"><a href="<?php echo base_url($this->uri->segment(1).'/trans');?>" class="dropk"><i class="fa fa-money pr-10"></i> 
                <?php if(isset($headmenus['transactions']) && !empty($headmenus['transactions'])){ echo $headmenus['transactions']; }else{ ?> TRANSACTIONS <?php } ?></a></li>
            <li style="border-bottom:1px solid #f4f4f4;"><a href="<?php echo base_url($this->uri->segment(1).'/drafts');?>" class="dropk"><i class="fa fa-file pr-10"></i> 
                <?php if(isset($headmenus['draft']) && !empty($headmenus['draft'])){ echo $headmenus['draft']; }else{ ?> DRAFT <?php } ?></a></li>
		    ...
		    ><i class="fa fa-sign-out pr-10"></i> <?php if(isset($headmenus['signout']) && !empty($headmenus['signout'])){ echo $headmenus['signout']; }else{ ?> SIGN OUT <?php } ?></a></li>
		</ul>
	</div>
	<div class="login logini">
		<a href="<?php echo base_url().$this->uri->segment(1);?>/notifications" style="color:#fff"><i class="fa fa-bell-o" aria-hidden="true"></i> <sup>0</sup></a>
	</div>
    ...
    <div class="nav-items">
    			...
    			<ul class="dropdown-menu pull-left" style="right:0!important; left:auto;">
    			    <?php foreach($languages->result() as $language ){ ?>
        				<li style="border-bottom:1px solid #f4f4f4;">
        				    <a class="dropk" style="padding:5px 10px; <?php if(isset($selectedlang) && ($selectedlang == $language->code)){ ?>color:red !important;background: none;<?php } ?>" href="<?php echo base_url().$language->langname;?>" title="<?php echo $language->language;?>"><?php echo $language->language;?></a>
        				</li>
                    <?php } ?>
                </ul>
            <?php } ?>
		...
		<div class="dropdown write-d">
			...
			<ul class="dropdown-menu pull-left" style="right:0!important; left:auto;">
				<?php if(isset($this->session->userdata['logged_in']['user_id']) && !empty($this->session->userdata['logged_in']['user_id'])){ ?>
					<li style="border-bottom:1px solid #f4f4f4;"><a class="dropk" href="<?php echo base_url($this->uri->segment(1).'/write-series'); ?>" title="Series"><i class="fa fa-indent pr-10"></i> 
					    <?php if(isset($headmenus['series']) && !empty($headmenus['series'])){ echo $headmenus['series']; }else{ ?> SERIES <?php } ?></a></li>
					<li style="border-bottom:1px solid #f4f4f4;"><a class="dropk" href="<?php echo base_url($this->uri->segment(1).'/write-story'); ?>" title="Story"><i class="fa fa-clipboard pr-10"></i> 
					    <?php if(isset($headmenus['story']) && !empty($headmenus['story'])){ echo $headmenus['story']; }else{ ?> STORY <?php } ?></a></li>
					<li style="border-bottom:1px solid #f4f4f4;"><a class="dropk" href="<?php echo base_url($this->uri->segment(1).'/write-nanostory'); ?>" title="Nano Story"><i class="fa fa-pie-chart pr-10"></i> 
		...
		<div><a href="<?php echo base_url($this->uri->segment(1).'/communities');?>" title="COMMUNITIES" class="dropdown-toggle">
		    <i class="fa fa-users" aria-hidden="true"></i>
		    <p><?php if(isset($headmenus['communities']) && !empty($headmenus['communities'])){ echo $headmenus['communities']; }else{ ?> COMMUNITIES <?php } ?></p></a>
		</div>
		<div>
			<?php if(isset($this->session->userdata['logged_in']['user_id']) && !empty($this->session->userdata['logged_in']['user_id'])){ ?>
			<a href="<?php echo base_url($this->uri->segment(1).'/feed'); ?>" title="YOUR FEED">
		...
		<div style="">
			<a href="<?php echo base_url($this->uri->segment(1).'/lifeall'); ?>" title="LIFE EVENTS"><i class="fa fa-heartbeat" aria-hidden="true"></i>
			    <p><?php if(isset($headmenus['life_events']) && !empty($headmenus['life_events'])){ echo $headmenus['life_events']; }else{ ?> LIFE EVENTS<?php } ?></p></a>
		</div>
			...
			<ul class="dropdown-menu pull-right" style="width:350px">
						...
						if(isset($notificationsclist['notseennotifys']) && ($notificationsclist['notseennotifys']->num_rows() > 0)){
							...
							<?php if(isset($notificationsclist['seennotifys']) && ($notificationsclist['seennotifys']->num_rows() > 0)){ 
								...
								foreach($notificationsclist['seennotifys']->result() as $seennotify){ 
									...
									<li>
										<a href="<?php echo base_url().$this->uri->segment(1).'/'.$seennotify->profile_name;?>" style="padding-top:0px;">
											<div class="user-block user-blockv" style="border-left:none;">
				...
				<li>
				    <?php if($seenunseennotifycount > 0){ ?>
					    <a href="<?php echo base_url().$this->uri->segment(1);?>/notifications" class="dropk" style="text-align:center;">
					        <?php if(isset($headmenus['show_more']) && !empty($headmenus['show_more'])){ echo $headmenus['show_more']; }else{ ?> SHOW MORE<?php } ?></a>
					<?php }else{ ?>
		...
		<div class="dropdown" style="border-left:none; width:50px; padding-top:6.5px; background:none;">
			...
			<ul class="dropdown-menu pull-right" style="padding-bottom:0px;right:5px;border:none;">
				<li style="border-bottom:1px solid #f4f4f4;border-left:none;">
				    <a href="<?php echo base_url($this->uri->segment(1).'/'.$profilename); ?>" class="dropk"><i class="fa fa-user pr-10"></i> 
				    <?php if(isset($headmenus['my_profile']) && !empty($headmenus['my_profile'])){ echo $headmenus['my_profile']; }else{ ?> MY PROFILE <?php } ?></a></li>
				<li style="border-bottom:1px solid #f4f4f4;border-left:none;"><a href="<?php echo base_url().$this->uri->segment(1);?>/my_profile/<?php echo $this->session->userdata['logged_in']['user_id'];?>" class="dropk"><i class="fa fa-sliders pr-10"></i> 
				    <?php if(isset($headmenus['settings']) && !empty($headmenus['settings'])){ echo $headmenus['settings']; }else{ ?> SETTINGS <?php } ?></a></li>
				<li style="border-bottom:1px solid #f4f4f4;border-left:none;"><a href="<?php echo base_url($this->uri->segment(1).'/trans');?>" class="dropk"><i class="fa fa-money pr-10"></i> 
				    <?php if(isset($headmenus['transactions']) && !empty($headmenus['transactions'])){ echo $headmenus['transactions']; }else{ ?> TRANSACTIONS <?php } ?></a></li>
				<li style="border-bottom:1px solid #f4f4f4;border-left:none;"><a href="<?php echo base_url($this->uri->segment(1).'/drafts');?>" class="dropk"><i class="fa fa-file pr-10"></i> 
				    <?php if(isset($headmenus['draft']) && !empty($headmenus['draft'])){ echo $headmenus['draft']; }else{ ?> DRAFT <?php } ?></a></li>
				<li style="border-bottom:1px solid #f4f4f4;border-left:none;"><a href="<?php echo base_url('logout');?>" class="dropk" 
				    ...
				    <?php }else if(isset($this->session->userdata['logged_in']['logintype']) && ($this->session->userdata['logged_in']['logintype'] == 'google')){ ?> onclick="signOut();" <?php } ?>>
				    <i class="fa fa-sign-out pr-10"></i><?php if(isset($headmenus['signout']) && !empty($headmenus['signout'])){ echo $headmenus['signout']; }else{ ?> SIGN OUT <?php } ?></a>
				</li>
    ...
    <div class="lang hidden-lan">
        <!--<div class="dropdown">
            <a href="<?php echo base_url().$this->uri->segment(1);?>search" class="dropdown-toggle" title="language" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true" style="color:#fff;"> 
            ...
            <ul class="dropdown-menu pull-left" style="right:0!important; left:auto;">
                <?php foreach($languages->result() as $language ){ ?>
				    <li style="border-bottom:1px solid #f4f4f4;">
				    <a class="dropk" style="cursor: grab; padding:5px 10px; <?php if(isset($sesslang) && ($sesslang == $language->code)){ ?>color:red !important;<?php } ?>" href="<?php echo base_url().$this->uri->segment(1)."/".$language->code;?>" title="<?php echo $language->language;?>"><?php echo $language->language;?></a></li>
				<?php } ?>
            </ul>
            <?php } ?>
        </div>-->
        <div class="dropdown">
		   ...
		   <?php if(isset($languages) && ($languages->num_rows() > 0)){ ?>
    			<ul class="dropdown-menu pull-left" style="right:0!important; left:auto;">
    			    <?php foreach($languages->result() as $language ){ ?>
        				<li style="border-bottom:1px solid #f4f4f4;">
        				    <a class="dropk" style="padding:5px 10px; <?php if(isset($selectedlang) && ($selectedlang == $language->code)){ ?>color:red !important;<?php } ?>" href="<?php echo base_url().$language->langname;?>" title="<?php echo $language->language;?>"><?php echo $language->language;?></a>
        				</li>
                    <?php } ?>
                </ul>
            <?php } ?>
    ...
    <div class="search-div2"><a href="<?php echo base_url().$this->uri->segment(1);?>/search" style="color:#fff;"><i class="fa fa-search" aria-hidden="true"></i></a></div>
...
<div class="nav-items2" id="navbar2">
	...
	<div>
		<a href="<?php echo base_url($this->uri->segment(1).'/communities');?>" title="COMMUNITIES" class="dropdown-toggle"><i class="fa fa-users" aria-hidden="true"></i>
		    <p><?php if(isset($headmenus['communities']) && !empty($headmenus['communities'])){ echo $headmenus['communities']; }else{ ?> COMMUNITIES <?php } ?></p></a>
	</div>
	<div>
		<?php if(isset($this->session->userdata['logged_in']['user_id']) && !empty($this->session->userdata['logged_in']['user_id'])){ ?>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">
                        <a href="<?php echo base_url().$this->uri->segment(1);?>/<?php echo $notseennotify->profile_name;?>">

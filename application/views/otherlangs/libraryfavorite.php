            ...
            <div class="cardls" id="frlibdel<?php echo $frseriesrow->sid;?>">
	            ...
	            <a href="<?php echo base_url($this->uri->segment(1).'/series/'.preg_replace('/\s+/', '-', $frseriesrow->title).'-'.$frseriesrow->sid.'/'.preg_replace('/\s+/', '-', $frseriesrow->title).'-'.$frseriesrow->story_id);?>" class="imagesls-style">
					...
					<div class="flextestls">
		                <font class="bynamels">By<font class="nameherels"><a href="<?php echo base_url($this->uri->segment(1).'/'.$frseriesrow->profile_name);?>" style="color:#000;"> <?php echo $frseriesrow->name;?></a></font></font>
                        <br>
					</div>
...
<?php if(isset($frstories) && ($frstories->num_rows() > 0)){ $frscount = $frscount+$frstories->num_rows(); ?>
    ...
    <div class="jc-m" style="display:flex; flex-wrap:wrap; margin-bottom:25px;">
		...
		<div class="cardls" id="frlibdel<?php echo $frstoriesrow->sid;?>">
			...
			<div class="flextest">
				<font class="byname">By<font class="namehere"><a href="<?php echo base_url($this->uri->segment(1).'/'.$frstoriesrow->profile_name);?>" style="color:#000;"> <?php echo $frstoriesrow->name;?></a></font></font>
				<br>
			</div>
        ...
        <?php foreach($frlife->result() as $frliferow) { ?>
            <div class="card1" style="margin-top:10px" id="frlibdel<?php echo $frliferow->sid;?>">
				...
				<div class="flextest">
					...
					<?php } else { ?>
						<font class="byname">By<font class="namehere"><a href="<?php echo base_url($this->uri->segment(1).'/'.$frliferow->profile_name);?>" style="color:#000;"> <?php echo $frliferow->name;?></a></font></font>
						<br>
					<?php } ?>
				</div>
				<div class="flextest" style="padding-top:4px;">
					<font class="lifeEvents-text"><?php echo mb_substr(strip_tags($frliferow->story),0,150);?></font>
				</div>
				<div class="flextest" style="padding-top:6px">

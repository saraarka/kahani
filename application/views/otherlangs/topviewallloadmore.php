<?php if(isset($topviewallloadmore) && ($topviewallloadmore->num_rows() >0) && ($this->uri->segment(3) == 'series')){ ?>
    ...
    <?php } ?>
<?php }else if(isset($topviewallloadmore) && ($topviewallloadmore->num_rows() >0) && ($this->uri->segment(3) == 'story')){ ?>
    <?php foreach($topviewallloadmore->result() as $topstorysrow) { ?>
        <div class="cardls">
			...
			<div>
				<font class="max-linesls">
					<a href="<?php echo base_url($this->uri->segment(1).'/story/'.preg_replace("~[^\p{M}\w]+~u", '-',$topstorysrow->title).'-'.$topstorysrow->sid);?>" class="product-title"><?php echo $topstorysrow->title;?>
					</a>
				</font> 
			</div>
			<div class="flextestls">
    ...
    <?php } ?>
<?php }else if(isset($topviewallloadmore) && ($topviewallloadmore->num_rows() >0) && ($this->uri->segment(3) == 'nano')){ ?>
    	...
    	<div class="nano-stories">
			<div>
				...
				<h3 class="name-nanostories">
				    <a href="<?php echo base_url().$this->uri->segment(1).'/'.$vahnanorow->profile_name;?>" style="height:50px; color:#000;"><?php echo $vahnanorow->name;?></a></h3>
			</div>
			<div>
				<hr style="width:100%;">
    ...
    <?php } ?>
<?php }else if(isset($topviewallloadmore) && ($topviewallloadmore->num_rows() >0) && ($this->uri->segment(3) == 'life')){ ?>

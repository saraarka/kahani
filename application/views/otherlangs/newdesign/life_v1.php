...
<form action="<?php echo base_url($this->uri->segment(1).'/life_story_uplode') ?>" id="display_result" method="post" name="registration" enctype="multipart/form-data">
	...
	<section class="content contentseries">
        <div style="display:flex; justify-content:center;">
    			...
    			<div class="" style="width:800px;">
    				<div class="box box-widget widget-user boxshv" style="padding:25px;height:416px;"><br>
    					<div class="row">

    			...
    			<div class="main-container1">
				    ...
				    <div class="nav-tabs-custom" style="margin-bottom:0px;">
                        <ul class="nav nav-tabs" style="background:#2a6283!important">
                            <li class="visiblev" onclick="aboutactive();"><a href="#tab_about" data-toggle="tab"><?php if(isset($profilemenu['about']) && !empty($profilemenu['about'])){ echo $profilemenu['about']; } else { ?>ABOUT<?php } ?></a></li>
                            <li class="active" onclick="aboutinactive();"><a href="#tab_writing" data-toggle="tab"><?php if(isset($profilemenu['writingtab']) && !empty($profilemenu['writingtab'])){ echo $profilemenu['writingtab']; } else{ ?>WRITINGS<?php } ?></a></li>
                            <li onclick="aboutinactive();"><a href="#tab_reading" data-toggle="tab"><?php if(isset($profilemenu['readingtab']) && !empty($profilemenu['readingtab'])){ echo $profilemenu['readingtab']; } else { ?>READING LIST<?php } ?></a></li>
                        </ul>
                    </div>
				                        	...
				                        	<div class="card">
    				                    		...
    				                    		<div class="flextest">
    				                    			<font class="byname">By <font class="namehere">
    				                    			    <a href="<?php echo base_url($this->uri->segment(1).'/'.$wstoryrow->profile_name);?>" style="color:#000"> <?php echo $wstoryrow->name;?></a></font></font><br>
    				                    		</div>
    				                    		<div class="flextest" style="padding-top:4px;">
    						                    	<font class = "episodes">
    						                    		<font>
                       ...
                       <!--  ------------------------------------------------------ -->
                        ...
                        <div class="tab-pane" id="tab_reading">
                            <div class="pull-right" style="padding-top:10px;">
        			            <span> <?php if(isset($profilemenu['readingtab']) && !empty($profilemenu['readingtab'])){ echo $profilemenu['readingtab']; } else { ?>Reading List<?php } ?> : &nbsp; </span> 
        			            <label class="switch">  

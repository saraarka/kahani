...
<html lang="en">
    ...
    <body>
        ...
        <form action="<?php echo base_url().$this->uri->segment(1);?>/life_story_uplode" onsubmit="return validateForm()" name="infoForm" id="display_result" method="post" enctype="multipart/form-data">
            <div class="write-nav">
...
<script>
    ...
    $('.tokenize-callable-demo1').tokenize2({
        ...
        dataSource: function(search, object){  // search and get tokens
            $.ajax('<?php echo base_url().$this->uri->segment(1);?>/lifetagssearch', {

...
<div class="content-wrapper">
    <section class="content">
        <?php if(isset($topviewallhome) && ($topviewallhome->num_rows() > 0) && (($this->uri->segment(2) == 'series') || (($this->uri->segment(1) == 'series') && ($this->uri->segment(2) == 'top')) ) ){ ?>
        ...
        <?php } else if(isset($topviewallhome) && ($topviewallhome->num_rows() > 0) && (($this->uri->segment(2) == 'nano') || ($this->uri->segment(1) == 'shortstories'))){ ?>
        <div class="main-container1">
		    <div class="row pt-0">
			    <div class="col-md-12 col-xs-12 pd-0">
            			...
            			<div class="nano-stories">
							<div>
								...
								<h3 class="name-nanostories">
								    <a href="<?php echo base_url().$nanorow->profile_name; ?>" style="color:#000;"><?php echo $nanorow->name;?></a></h3>
							</div>
							<div>
								<hr style="width:100%;">
        ...
        <?php } else if(isset($topviewallhome) && ($topviewallhome->num_rows() > 0) && (($this->uri->segment(2) == 'life') || (($this->uri->segment(1) == 'lifeevents') && ($this->uri->segment(2) == 'top')) ) ){ ?>
...
<script>
    $(document).ready(function(){
        ...
        function load_country_data(limit, start) {
            ...
            if((typeseg == 'series') && (vatype == 'top')){
                vatype = 'series';
            }else if((typeseg == 'stories') && (vatype == 'top')){
                vatype = 'story';
            ...
            $.ajax({
                url:'<?php echo base_url();?>topviewallloadmore/'+vatype,
                method:"POST",

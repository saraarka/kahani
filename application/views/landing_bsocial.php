...
<body>
    ...
    <div class="header">
        ...
        <?php } } else{ ?>
        <img src="<?php echo base_url();?>assets/landing/logom.jpg" alt="storycarry.com" style="width: 70px;margin-top: 10px;margin-left: 15px;">
        <?php } ?>
        ...
        <div class="totalbody1">
            ...
            <header>
                ...
                <div style="display: inline-block;margin:15px 50px 0px 0px; float: right;">
                    <a href="#genv" style="color:#fff; text-decoration:none" data-toggle="modal" data-target="#genv">FAQ</a>
                    <font class="login-but">
                        <a href="#loginmodal" style="color:#fff; text-decoration:none" data-toggle="modal" data-target="#loginmodal">LOGIN</a>
                    </font>
                </div>
    ...
    <div class="footer1">
        <div style="font-size:14px;color:black;font-family: 'Varela Round', sans-serif;">
            <center>
                <font style="margin-right:10px" class="hover-tems"><a herf="<?php echo base_url();?>about">ABOUT</a></font>
                <font style="margin-right:10px" class="hover-tems"><a herf="<?php echo base_url();?>contact">CONTACT</a></font>
                <font style="margin-right:10px" class="hover-tems"><a herf="<?php echo base_url();?>terms">TERMS</a></font>
                <font class="hover-tems"><a herf="<?php echo base_url();?>privacy">PRIVACY</a></font>
            </center>
        </div>
    </div>  <!-- footer end -->

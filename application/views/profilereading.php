        ...
        <div id="StoryContv1" class="StoryCont1" style="text-align:left;">
            ...
            <?php foreach($rlseries->result() as $rlseriesrow){ ?>
            	<div class="card">
        			...
        			<a href="<?php echo base_url('series/'.preg_replace("~[^\p{M}\w]+~u", '-', $rlseriesrow->title).'-'.$rlseriesrow->sid.'/'.preg_replace("~[^\p{M}\w]+~u", '-', $rlseriesrow->title).'-'.$rlseriesrow->story_id);?>" class="imagess-style">
            		...
            		<div class="flextest">
            			<font class="byname">By<font class="namehere">
            			    <a href="<?php echo base_url($rlseriesrow->profile_name);?>" style="color:#000"> <?php echo $rlseriesrow->name;?></a></font></font><br>
            		</div>
        ...
        <div id="StoryCont2s" class="StoryCont1" style="text-align:left;">
            <div id="story-slider2s" class="story-slider series">
                ...
                <div class="card">
        			...
        			<a href="<?php echo base_url('story/'.preg_replace("~[^\p{M}\w]+~u", '-', $rlstoryrow->title).'-'.$rlstoryrow->sid);?>" class="imagess-style">
            		...
            		<div class="flextest">
            			<font class="byname">By<font class="namehere">
            			    <a href="<?php echo base_url($rlstoryrow->profile_name);?>" style="color:#000"> <?php echo $rlstoryrow->name;?></a></font></font><br>
            		</div>
            		<div class="flextest" style="padding-top:4px;">
                    	<font class = "episodes">
                    		<font>
        		...
        		<?php $i = 0; foreach($rllife->result() as $rlliferow) { if($i < 3){ ?>
        			<div class="card1">
        				...
        				<div class="flextest">
        					...
        					<?php } else { ?>
        						<font class="byname">By<font class="namehere">
        						    <a href="<?php echo base_url().$rlliferow->profile_name; ?>" style="color:#000;"> <?php echo $rlliferow->name;?></a></font></font>
        						<br>
        					<?php } ?>
        				</div>

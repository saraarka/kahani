				    ...
				    <div id="story-slider" class="story-slider series">
    				    <?php $i=0; foreach($top_get_series->result() as $topseriesrow) { if($i<4){  ?>
    				    	<div class="card">
        						...
        						<div class="flextest">
        							<font class="byname">By<font class="namehere"><a href="<?php echo base_url($topseriesrow->profile_name);?>" style="color:#000"> <?php echo $topseriesrow->name;?></a></font></font><br>
        						</div>
    				...
    				<div class="cardls">
					    <div class="book-typels"><?php echo $seriesrow->gener;?></div>
    						...
    						<div class="flextestls">
    							<font class="bynamels">By<font class="nameherels"><a href="<?php echo base_url($seriesrow->profile_name);?>" style="color:#000"> <?php echo $seriesrow->name;?></a></font></font><br>
    						</div>
...
<script>
	function generfilter(generid){
		if((generid == 0) || (generid == '') || (generid == 'undefined') || (generid == ' ') || (generid == 'null')){
			...
			$.ajax({
				type:'POST',
				url:'<?php echo base_url();?>welcome/geners',
    ...
    $(document).ready(function(){
        ...
        function load_country_data(limit, start) {
            ...
            if(typeseries == 'series'){
                $.ajax({
                    url:'<?php echo base_url();?>welcome/viewallloadmore/series',
                    method:"POST",
        ...
        $(window).scroll(function(){
            //if($(window).scrollTop() + $(window).height() + 500 > $("#loadmoreall").height() && action == 'inactive'){
